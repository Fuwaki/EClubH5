...
#define LOW_PRECISION`),e}function gM(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Hh?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===zv?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Qn&&(e="SHADOWMAP_TYPE_VSM"),e}function vM(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case $r:case jr:e="ENVMAP_TYPE_CUBE";break;case ua:e="ENVMAP_TYPE_CUBE_UV";break}return e}function _M(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case jr:e="ENVMAP_MODE_REFRACTION";break}return e}function xM(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Vh:e="ENVMAP_BLENDING_MULTIPLY";break;case s_:e="ENVMAP_BLENDING_MIX";break;case o_:e="ENVMAP_BLENDING_ADD";break}return e}function bM(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function yM(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=gM(t),c=vM(t),u=_M(t),d=xM(t),f=bM(t),p=lM(t),v=cM(s),g=r.createProgram();let m,h,y=t.glslVersion?"#version "+t.glslVersion+`
...
初见时羞涩的我们，团建时燃烧的热情（还挺应景，第一次吃的烤肉），男生节女生节"蓄谋已久"的惊喜，都是我们团队的注脚！`,images:["/features/h.jpg","/features/j.jpg","/features/k.jpg","/features/l.jpg"]}],t=Je(null);function i(d){t.value=t.value===d?null:d}const r=Je(null);function s(d){r.value=d}function o(){r.value=null}function a(d){const f=d;f.style.overflow="hidden",f.style.height="0",f.style.opacity="0",f.offsetHeight;const p=f.scrollHeight;f.style.transition="height .42s cubic-bezier(.34,.64,.36,1), opacity .3s ease",f.style.height=p+"px",f.style.opacity="1"}function l(d){const f=d;f.style.height="auto",f.style.overflow=""}function c(d){const f=d;f.style.overflow="hidden";const p=f.scrollHeight;f.style.height=p+"px",f.offsetHeight,f.style.transition="height .32s cubic-bezier(.68,.12,.47,.98), opacity .24s ease",f.style.height="0",f.style.opacity="0"}function u(d){const f=d;f.style.overflow=""}return(d,f)=>{const p=fi("reveal"),v=fi("tilt");return ne(),ie(Mt,null,[R("div",uE,[Me((ne(),ie("div",dE,[Me((ne(),ie("h2",fE,[...f[2]||(f[2]=[it("关于电子俱乐部",-1)])])),[[p,void 0,'"pop"']]),Me((ne(),ie("p",hE,[...f[3]||(f[3]=[it("我们是校园里的技术共同体：我们可以让灵感变成作品，可以让知识得以传递，让成长默默发生",-1)])])),[[p,void 0,'"up"']]),Me((ne(),ie("p",pE,[...f[4]||(f[4]=[it("这里有工程视角，也有人际交往；有代码与电路，也有内容与组织。",-1)])])),[[p,void 0,'"up"']]),Me((ne(),ie("div",mE,[...f[5]||(f[5]=[R("span",{class:"px-3 py-1 rounded-full bg-emerald-400/15 border border-emerald-400/30"},"好奇",-1),R("span",{class:"px-3 py-1 rounded-full bg-emerald-400/15 border border-emerald-400/30"},"协作",-1),R("span",{class:"px-3 py-1 rounded-full bg-cyan-400/15 border border-cyan-400/30"},"责任心",-1),R("span",{class:"px-3 py-1 rounded-full bg-cyan-400/15 border border-cyan-400/30"},"发展",-1)])])),[[p,void 0,'"fade"']]),R("div",gE,[(ne(),ie(Mt,null,En(e,(g,m)=>Me(R("div",{key:g.title,class:"group relative self-start rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/50 to-slate-800/30 p-3 sm:p-4 hover:border-emerald-400/30 hover:bg-slate-800/40 transition cursor-pointer shadow-lg hover:shadow-emerald-400/20","aria-expanded":t.value===m,role:"group",reveal:{delay:220+m*70},onClick:h=>i(m)},[R("div",_E,[R("span",xE,ot(g.icon),1),R("span",bE,[R("span",yE,[it(ot(g.title)+" ",1),t.value===m?(ne(),ie("span",SE,"▲")):(ne(),ie("span",ME,"▼"))]),R("span",{class:At(["block mt-1 text-[11px] sm:text-xs text-emerald-100/70 line-clamp-2 group-hover:text-emerald-100/90 transition",{"opacity-0":t.value===m}])},ot(g.brief),3)])]),rt(Ml,{onEnter:a,onAfterEnter:l,onLeave:c,onAfterLeave:u},{default:Fr(()=>[t.value===m?(ne(),ie("div",{key:0,class:"mt-3 text-[11px] sm:text-xs leading-relaxed text-emerald-100/85",onClick:f[0]||(f[0]=vn(()=>{},["stop"]))},[g.images&&g.images.length?(ne(),ie("div",EE,[(ne(!0),ie(Mt,null,En(g.images,(h,y)=>(ne(),ie("img",{key:y,src:h,alt:g.title+" 图 "+(y+1),class:"h-24 w-full object-cover rounded-md border border-white/10 hover:border-emerald-400/40 hover:brightness-110 active:scale-[0.97] transition cursor-pointer",loading:"lazy",decoding:"async",onClick:vn(S=>s(h),["stop"])},null,8,TE))),128))])):g.img?(ne(),ie("div",wE,[R("img",{src:g.img,alt:g.title,class:"w-full h-28 object-cover hover:brightness-110 transition",loading:"lazy",decoding:"async",onClick:vn(h=>s(g.img),["stop"])},null,8,AE)])):dt("",!0),R("pre",RE,ot(g.full),1)])):dt("",!0)]),_:2},1024),f[6]||(f[6]=R("div",{class:"pointer-events-none absolute inset-0 rounded-xl ring-1 ring-white/10 group-hover:ring-emerald-400/30 transition"},null,-1)),f[7]||(f[7]=R("div",{class:"absolute -inset-px rounded-xl opacity-0 group-hover:opacity-100 transition duration-500 bg-[radial-gradient(circle_at_30%_20%,rgba(16,185,129,0.2),transparent_60%),radial-gradient(circle_at_70%_80%,rgba(34,211,238,0.18),transparent_60%)]"},null,-1))],8,vE),[[p,void 0,'"pop"'],[v,{max:8,scale:1.02}]])),64))])])),[[p]])]),(ne(),Rs(Xf,{to:"body"},[r.value?(ne(),ie("div",{key:0,class:"fixed inset-0 z-[60] bg-black/85 backdrop-blur-sm flex items-center justify-center p-4",onClick:o},[R("img",{src:r.value,alt:"preview",class:"max-w-full max-h-full rounded-lg shadow-xl border border-white/10",onClick:f[1]||(f[1]=vn(()=>{},["stop"]))},null,8,CE),R("button",{class:"absolute top-4 right-4 w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 text-white text-lg flex items-center justify-center backdrop-blur-sm border border-white/20",onClick:vn(o,["stop"])},"×")])):dt("",!0)]))],64)}}}),DE=Gn(PE,[["__scopeId","data-v-74c77138"]]),LE={},IE={class:"relative px-4 sm:px-5 py-14 sm:py-16"},UE={class:"w-full max-w-screen-lg mx-auto"},NE={class:"inline-block relative"},FE={class:"mt-4 sm:mt-5 text-emerald-100/85 text-[15px] sm:text-base leading-relaxed px-1 sm:px-0",reveal:{delay:100}},OE={class:"mt-8 relative",reveal:{delay:160}},BE={class:"flex flex-col gap-5",reveal:{delay:220}},kE={class:"flex flex-col md:flex-row gap-4 md:gap-6"},zE={class:"flex-1 bg-gradient-to-br from-emerald-900/30 to-slate-900/30 rounded-xl border border-white/10 p-5 md:p-6",reveal:{delay:260}},HE={class:"flex-1 bg-gradient-to-br from-cyan-900/30 to-slate-900/30 rounded-xl border border-white/10 p-5 flex items-center justify-center",reveal:{delay:320}},VE={class:"grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4",reveal:{delay:380}},GE={class:"rounded-xl border border-white/10 bg-white/5 p-4 flex flex-col items-center text-center hover:bg-white/10 transition",reveal:{delay:400}},WE={class:"rounded-xl border border-white/10 bg-white/5 p-4 flex flex-col items-center text-center hover:bg-white/10 transition",reveal:{delay:460}},XE={class:"rounded-xl border border-white/10 bg-white/5 p-4 flex flex-col items-center text-center hover:bg-white/10 transition",reveal:{delay:520}},$E={class:"rounded-xl border border-white/10 bg-white/5 p-4 flex flex-col items-center text-center hover:bg-white/10 transition",reveal:{delay:580}},jE={class:"bg-gradient-to-r from-emerald-900/40 via-cyan-900/40 to-emerald-900/40 rounded-xl border border-white/10 p-4 sm:p-5",reveal:{delay:660}};function qE(n,e){const t=fi("reveal");return ne(),ie("div",IE,[Me((ne(),ie("div",UE,[Me((ne(),ie("div",NE,[...e[0]||(e[0]=[R("h2",{class:"text-2xl sm:text-3xl font-bold bg-gradient-to-r from-emerald-400 to-cyan-400 text-transparent bg-clip-text"}," 我们的优势",-1),R("div",{class:"absolute -bottom-2 left-0 right-0 h-[2px] bg-gradient-to-r from-emerald-400 to-cyan-400"},null,-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("p",FE,[...e[1]||(e[1]=[it("老牌部门+社团，助你快速成长",-1)])])),[[t,void 0,'"up"']]),Me((ne(),ie("div",OE,[e[9]||(e[9]=R("div",{class:"absolute inset-0 -z-10"},[R("div",{class:"absolute top-1/3 left-1/4 w-32 h-32 bg-emerald-500/10 rounded-full blur-3xl"}),R("div",{class:"absolute bottom-1/4 right-1/3 w-40 h-40 bg-cyan-500/10 rounded-full blur-3xl"})],-1)),Me((ne(),ie("div",BE,[R("div",kE,[Me((ne(),ie("div",zE,[...e[2]||(e[2]=[kt('<div class="flex items-start"><div class="flex-shrink-0 p-3 bg-emerald-400/15 rounded-lg"><span class="text-2xl">🚀</span></div><div class="ml-4"><h3 class="font-bold text-lg text-emerald-200">项目落地与实战协作</h3><p class="mt-1 text-xs text-cyan-100/80">懂方法，能应用，强配合</p></div></div>',1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",HE,[...e[3]||(e[3]=[kt('<div class="text-center"><div class="inline-block p-4 rounded-full bg-cyan-400/15 mb-3"><span class="text-3xl">🏆</span></div><h3 class="font-bold text-cyan-200">竞赛支持</h3><p class="mt-1 text-xs text-cyan-100/80">资料/报名指导</p></div>',1)])])),[[t,void 0,'"pop"']])]),Me((ne(),ie("div",VE,[Me((ne(),ie("div",GE,[...e[4]||(e[4]=[R("div",{class:"text-2xl mb-2"},"🧭",-1),R("div",{class:"font-semibold"},"有我们在",-1),R("div",{class:"text-xs text-emerald-100/80 mt-1"},"学长学姐 1v1 指导",-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",WE,[...e[5]||(e[5]=[R("div",{class:"text-2xl mb-2"},"🔌",-1),R("div",{class:"font-semibold"},"设备与场地",-1),R("div",{class:"text-xs text-emerald-100/80 mt-1"},"部门仓库&办公室",-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",XE,[...e[6]||(e[6]=[R("div",{class:"text-2xl mb-2"},"📣",-1),R("div",{class:"font-semibold"},"校园影响力",-1),R("div",{class:"text-xs text-emerald-100/80 mt-1"},"作品展示与传播",-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",$E,[...e[7]||(e[7]=[R("div",{class:"text-2xl mb-2"},"📚",-1),R("div",{class:"font-semibold"},"资历丰富",-1),R("div",{class:"text-xs text-emerald-100/80 mt-1"},"多年社团沉淀与经验",-1)])])),[[t,void 0,'"pop"']])])),[[t,void 0,'"up"']]),Me((ne(),ie("div",jE,[...e[8]||(e[8]=[kt('<div class="flex flex-col sm:flex-row items-center gap-4"><div class="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-400 flex items-center justify-center text-black text-3xl"> 💡</div><div class="flex-1 text-center sm:text-left"><h3 class="font-bold text-lg">创新氛围与成长环境</h3><p class="mt-1 text-sm text-emerald-100/90">在这里，我们变点子为作品，行创意于实践，留成长给明天。</p></div></div>',1)])])),[[t,void 0,'"pop"']])])),[[t,void 0,'"up"']])])),[[t,void 0,'"fade"']])])),[[t]])])}const YE=Gn(LE,[["render",qE]]),KE={},ZE={class:"relative px-4 sm:px-5 py-14 sm:py-16 cv-auto"},JE={class:"w-full max-w-screen-lg mx-auto grid md:grid-cols-2 gap-6 sm:gap-10"},QE={class:"mt-3 sm:mt-4 space-y-2 text-emerald-100/85 text-[15px] leading-relaxed",reveal:{delay:120}},e1={reveal:{delay:160}},t1={class:"mt-4 grid grid-cols-2 gap-3 text-sm",reveal:{delay:240}},n1={class:"mt-5",reveal:{delay:340}};function i1(n,e){const t=fi("reveal");return Me((ne(),ie("div",ZE,[R("div",JE,[Me((ne(),ie("div",null,[e[1]||(e[1]=R("h3",{class:"text-xl sm:text-2xl font-bold"},"我们希望你",-1)),Me((ne(),ie("ul",QE,[...e[0]||(e[0]=[R("li",null,"• 对技术或设计保持好奇心，愿意动手探索",-1),R("li",null,"• 愿意为学校工作出力（我们可是正经的学生会哦）",-1),R("li",null,"• 乐于沟通、保持开放",-1),R("li",null,"• 不设门槛，零基础亦可，只要愿意持续学习",-1)])])),[[t,void 0,'"up"']])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",e1,[e[4]||(e[4]=R("h3",{class:"text-xl sm:text-2xl font-bold"},"我们的小部门",-1)),Me((ne(),ie("div",t1,[...e[2]||(e[2]=[kt('<div class="rounded-lg border border-emerald-400/20 bg-emerald-400/10 px-3 py-2">技术部</div><div class="rounded-lg border border-cyan-400/20 bg-cyan-400/10 px-3 py-2">团支部</div><div class="rounded-lg border border-emerald-400/20 bg-emerald-400/10 px-3 py-2">常务部</div><div class="rounded-lg border border-cyan-400/20 bg-cyan-400/10 px-3 py-2">外联部</div><div class="rounded-lg border border-emerald-400/20 bg-emerald-400/10 px-3 py-2">部长部</div><div class="rounded-lg border border-cyan-400/20 bg-cyan-400/10 px-3 py-2 relative overflow-hidden"><span class="relative z-10">隐藏款</span><span class="absolute inset-0 flex items-center justify-center text-xl font-bold text-cyan-400/10 select-none">MEG</span></div>',6)])])),[[t,void 0,'"fade"']]),Me((ne(),ie("div",n1,[...e[3]||(e[3]=[R("a",{href:"#join",class:"inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-emerald-500 to-cyan-500 text-black font-semibold active:scale-[0.99]"},[it(" 现在报名 "),R("span",null,"→")],-1)])])),[[t,void 0,'"pop"']])])),[[t,void 0,'"pop"']])])])),[[t]])}const r1=Gn(KE,[["render",i1]]),s1={class:"relative px-4 sm:px-5 py-14 sm:py-16 cv-auto",reveal:{delay:380}},o1={class:"w-full max-w-screen-lg mx-auto grid md:grid-cols-2 gap-8 sm:gap-10 items-center"},a1={class:"order-1 md:order-2 reveal-in",style:{opacity:"1",transform:"none",filter:"none"}},l1={class:"md:hidden"},c1={class:"flex gap-3 overflow-x-auto w-full max-w-[100vw] py-1 scroll-hint no-scrollbar",style:{"scroll-snap-type":"x mandatory","-webkit-overflow-scrolling":"touch","overflow-x":"auto !important"}},u1=["src","onClick"],d1={class:"hidden md:block"},f1={class:"relative aspect-[4/3] rounded-xl overflow-hidden bg-slate-900/70 border border-white/10"},h1={class:"absolute inset-0 grid grid-cols-3 grid-rows-3 gap-2 p-2"},p1=["src","onClick"],m1=["src"],g1=Jt({__name:"ProjectsSection",setup(n){const e=Je(null),t=f=>e.value=f,i=()=>{e.value=null,o.value=0,a.value=!1},r=["/works/a.jpg","/works/b.jpg","/works/c.jpg","/works/d.jpg","/works/e.jpg","/works/f.jpg","/works/g.jpg","/works/h.jpg","/works/i.jpg"],s=Je(0),o=Je(0),a=Je(!1),l=Ht(()=>Math.max(.3,.85-Math.min(.55,o.value/600)));function c(f){e.value&&(a.value=!0,s.value=f.touches[0].clientY,o.value=0)}function u(f){if(!a.value)return;const p=f.touches[0].clientY-s.value;p>0&&(o.value=p)}function d(){a.value&&(a.value=!1,o.value>90?i():o.value=0)}return(f,p)=>{const v=fi("reveal");return Me((ne(),ie("div",s1,[R("div",o1,[p[1]||(p[1]=kt('<div class="order-2 md:order-1"><h2 class="text-2xl sm:text-3xl font-bold">去实践，就是最好的学习</h2><p class="mt-3 sm:mt-4 text-emerald-100/80 leading-relaxed text-[15px] sm:text-base"> 从 0 到 1 完整经历：需求调研、方案设计、开发协作。学的不止是技术，更是把事情做成的能力。 </p><ul class="mt-4 sm:mt-6 space-y-2 text-emerald-100/80 text-sm list-disc list-inside"><li>硬件小制作</li><li>LED创新大赛</li><li>技术创意应用</li></ul><p class="mt-4 sm:mt-6 text-emerald-100/80 text-sm italic"> 让电子俱乐部成为你大放异彩的舞台 </p></div>',1)),R("div",a1,[R("div",l1,[R("div",c1,[(ne(),ie(Mt,null,En(r,g=>R("div",{key:g,class:"relative snap-center flex-shrink-0 w-[85vw] sm:w-[70vw] aspect-[4/3] rounded-xl overflow-hidden bg-slate-900/70 border border-white/10 transition"},[R("img",{src:g,alt:"项目作品展示",class:"absolute inset-0 w-full h-full object-cover cursor-zoom-in",loading:"lazy",decoding:"async",sizes:"(max-width: 768px) 85vw, 400px",onClick:m=>t(g)},null,8,u1)])),64))])]),R("div",d1,[R("div",f1,[R("div",h1,[(ne(),ie(Mt,null,En(r,g=>R("div",{key:g,class:"relative rounded-lg bg-emerald-400/20 overflow-hidden"},[R("img",{src:g,alt:"项目作品展示",class:"absolute inset-0 w-full h-full object-cover cursor-zoom-in",loading:"lazy",decoding:"async",sizes:"(max-width: 1024px) 33vw, 320px",onClick:m=>t(g)},null,8,p1)])),64))])])])])]),(ne(),Rs(Xf,{to:"body"},[e.value?(ne(),ie("div",{key:0,class:"fixed inset-0 z-[60] backdrop-blur-sm flex items-center justify-center p-4",onClick:i,style:ai({backgroundColor:`rgba(0,0,0,${l.value})`}),onTouchstartPassive:c,onTouchmove:vn(u,["prevent"]),onTouchendPassive:d},[R("div",{class:"relative",style:ai({transform:o.value?`translateY(${o.value}px)`:""}),onClick:p[0]||(p[0]=vn(()=>{},["stop"]))},[R("img",{src:e.value,alt:"preview",class:"max-w-[95vw] max-h-[85vh] rounded-lg shadow-xl border border-white/10"},null,8,m1),R("button",{class:"absolute -top-3 -right-3 w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 text-white text-lg flex items-center justify-center backdrop-blur-sm border border-white/20",onClick:i},"×")],4)],36)):dt("",!0)]))])),[[v,void 0,'"up"']])}}}),v1={},_1={class:"relative px-4 sm:px-5 py-14 sm:py-16 cv-auto"},x1={class:"w-full max-w-screen-lg mx-auto grid md:grid-cols-2 gap-8 sm:gap-10 items-center"},b1={reveal:{delay:140}},y1={class:"mt-3 sm:mt-4 text-emerald-100/80 leading-relaxed text-[15px] sm:text-base",reveal:{delay:220}},S1={class:"mt-4 sm:mt-6 grid grid-cols-2 gap-3 text-sm",reveal:{delay:300}};function M1(n,e){const t=fi("reveal");return Me((ne(),ie("div",_1,[R("div",x1,[Me((ne(),ie("div",null,[...e[0]||(e[0]=[kt('<div class="relative aspect-video rounded-xl overflow-hidden bg-slate-900/70 border border-white/10 flex items-center justify-center"><div class="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(16,185,129,0.25),transparent_60%)]"></div><div class="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(34,211,238,0.2),transparent_60%)]"></div><div class="relative z-10 text-center"><div class="text-5xl font-black tracking-tight">0 → 1</div><div class="mt-3 text-xs sm:text-sm text-emerald-100/80">每周例会 / 部长带队</div></div></div>',1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",b1,[e[3]||(e[3]=R("h2",{class:"text-2xl sm:text-3xl font-bold"},"路虽远，行则将至 我们携手这一程",-1)),Me((ne(),ie("p",y1,[...e[1]||(e[1]=[it("每位新成员会得到学习路径建议与部长指导，前期也会提供项目模板与工具链，快速上手并构建自信。",-1)])])),[[t,void 0,'"up"']]),Me((ne(),ie("div",S1,[...e[2]||(e[2]=[R("div",{class:"px-3 py-2 rounded-lg bg-emerald-400/10 border border-emerald-400/20"},"内部技术教学",-1),R("div",{class:"px-3 py-2 rounded-lg bg-cyan-400/10 border border-cyan-400/20"},"仓库管理",-1),R("div",{class:"px-3 py-2 rounded-lg bg-emerald-400/10 border border-emerald-400/20"},"活动组织",-1),R("div",{class:"px-3 py-2 rounded-lg bg-cyan-400/10 border border-cyan-400/20"},"宣发 / 运营",-1)])])),[[t,void 0,'"fade"']])])),[[t,void 0,'"pop"']])])])),[[t]])}const E1=Gn(v1,[["render",M1]]),af="/honors/1.jpg",lf="/honors/2.jpg",cf="/honors/3.jpg",uf="/honors/4.jpg",T1={},w1={class:"relative px-4 sm:px-5 py-14 sm:py-16 cv-auto"},A1={class:"w-full max-w-screen-lg mx-auto"},R1={class:"text-2xl sm:text-3xl font-bold text-center"},C1={class:"mt-7 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4",reveal:{delay:140}},P1={class:"grid grid-cols-2 gap-4 sm:hidden",reveal:{delay:140}},D1={class:"relative rounded-xl overflow-hidden shadow-lg group cursor-pointer active:scale-[0.99] transition-transform",reveal:{delay:200}},L1={class:"relative rounded-xl overflow-hidden shadow-lg group cursor-pointer active:scale-[0.99] transition-transform",reveal:{delay:260}},I1={class:"relative rounded-xl overflow-hidden shadow-lg group cursor-pointer active:scale-[0.99] transition-transform",reveal:{delay:320}},U1={class:"relative rounded-xl overflow-hidden shadow-lg group cursor-pointer active:scale-[0.99] transition-transform",reveal:{delay:380}},N1={class:"relative rounded-xl overflow-hidden shadow-lg group cursor-pointer active:scale-[0.99] transition-transform hidden sm:block",reveal:{delay:200}},F1={class:"relative rounded-xl overflow-hidden shadow-lg group cursor-pointer active:scale-[0.99] transition-transform hidden sm:block",reveal:{delay:260}},O1={class:"relative rounded-xl overflow-hidden shadow-lg group cursor-pointer active:scale-[0.99] transition-transform hidden sm:block",reveal:{delay:320}},B1={class:"relative rounded-xl overflow-hidden shadow-lg group cursor-pointer active:scale-[0.99] transition-transform hidden sm:block",reveal:{delay:380}};function k1(n,e){const t=fi("reveal");return Me((ne(),ie("div",w1,[R("div",A1,[Me((ne(),ie("h2",R1,[...e[0]||(e[0]=[it("活动与荣誉",-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",C1,[Me((ne(),ie("div",P1,[Me((ne(),ie("div",D1,[...e[1]||(e[1]=[R("img",{src:af,alt:"快乐团建时光",class:"w-full h-35 object-cover"},null,-1),R("div",{class:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"},null,-1),R("div",{class:"absolute bottom-0 left-0 right-0 p-3"},[R("div",{class:"text-white font-medium text-sm"},"运动这一块")],-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",L1,[...e[2]||(e[2]=[R("img",{src:lf,alt:"大佬云集",class:"w-full h-35 object-cover"},null,-1),R("div",{class:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"},null,-1),R("div",{class:"absolute bottom-0 left-0 right-0 p-3"},[R("div",{class:"text-white font-medium text-sm"},"科普这一块")],-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",I1,[...e[3]||(e[3]=[R("img",{src:cf,alt:"院内教学",class:"w-full h-35 object-cover"},null,-1),R("div",{class:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"},null,-1),R("div",{class:"absolute bottom-0 left-0 right-0 p-3"},[R("div",{class:"text-white font-medium text-sm"},"社团这一块")],-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",U1,[...e[4]||(e[4]=[R("img",{src:uf,alt:"十佳社团",class:"w-full h-35 object-cover"},null,-1),R("div",{class:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"},null,-1),R("div",{class:"absolute bottom-0 left-0 right-0 p-3"},[R("div",{class:"text-white font-medium text-sm"},"配音这一块")],-1)])])),[[t,void 0,'"pop"']])])),[[t,void 0,'"fade"']]),Me((ne(),ie("div",N1,[...e[5]||(e[5]=[R("img",{src:af,alt:"快乐团建时光",class:"h-40 sm:h-56 w-full object-cover"},null,-1),R("div",{class:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"},null,-1),R("div",{class:"absolute bottom-0 left-0 right-0 p-4 sm:p-6"},[R("div",{class:"text-white font-medium text-lg"},"运动这一块")],-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",F1,[...e[6]||(e[6]=[R("img",{src:lf,alt:"大佬云集",class:"h-40 sm:h-56 w-full object-cover"},null,-1),R("div",{class:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"},null,-1),R("div",{class:"absolute bottom-0 left-0 right-0 p-4 sm:p-6"},[R("div",{class:"text-white font-medium text-lg"},"科普这一块")],-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",O1,[...e[7]||(e[7]=[R("img",{src:cf,alt:"院内教学",class:"h-40 sm:h-56 w-full object-cover"},null,-1),R("div",{class:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"},null,-1),R("div",{class:"absolute bottom-0 left-0 right-0 p-4 sm:p-6"},[R("div",{class:"text-white font-medium text-lg"},"社团这一块")],-1)])])),[[t,void 0,'"pop"']]),Me((ne(),ie("div",B1,[...e[8]||(e[8]=[R("img",{src:uf,alt:"十佳社团",class:"h-40 sm:h-56 w-full object-cover"},null,-1),R("div",{class:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"},null,-1),R("div",{class:"absolute bottom-0 left-0 right-0 p-4 sm:p-6"},[R("div",{class:"text-white font-medium text-lg"},"配音这一块")],-1)])])),[[t,void 0,'"pop"']])])),[[t,void 0,'"fade"']])])])),[[t]])}const z1=Gn(T1,[["render",k1]]),H1="/group_qr.jpg",V1="/qq_qr.jpg",G1={class:"w-full max-w-screen-sm mx-auto"},W1={class:"sr-only","aria-hidden":"true"},X1={class:"relative"},$1=["aria-invalid"],j1={key:0,class:"mt-1 text-xs text-rose-400"},q1={class:"grid grid-cols-2 gap-3"},Y1={class:"relative"},K1={key:0,class:"mt-1 text-xs text-rose-400"},Z1={class:"relative"},J1={key:0,class:"mt-1 text-xs text-rose-400"},Q1={class:"grid grid-cols-3 gap-2 items-start"},eT={key:1,class:"col-span-3 relative"},tT={class:"absolute -bottom-4 right-0 text-[10px] text-emerald-100/50"},nT={key:0,class:"mt-1 text-xs text-rose-400"},iT={class:"relative"},rT=["maxlength"],sT={class:"mt-2 flex items-center justify-between text-xs"},oT={class:"h-1 flex-1 rounded bg-white/10 mr-3 overflow-hidden"},aT={class:"text-emerald-100/70"},lT={key:0,class:"mt-1 text-xs text-rose-400"},cT=["disabled"],uT={key:0},dT={key:1},fT={key:0,class:"text-center text-xs text-rose-400 mt-1"},hT={key:0,class:"fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+16px)] mx-auto w-[90%] max-w-sm px-4 py-3 rounded-xl bg-emerald-500 text-black text-center shadow-lg"},pT="https://eclubapi.kitramgp.cn/api/join",us=200,mT=30,gT=Jt({__name:"JoinForm",setup(n){const e=Hr({majorClass:"",studentId:"",name:"",stack:"",message:"",customStack:""}),t=Hr({majorClass:!1,studentId:!1,name:!1,stack:!1,message:!1,customStack:!1}),i=Je(!1),r=Je(!1),s=Je(""),o=Je(Number(localStorage.getItem("join_last_submit")||0)),a=Je(Date.now());let l;gi(()=>{l=window.setInterval(()=>{a.value=Date.now()},1e3)}),Pc(()=>{l&&clearInterval(l)});const c=Ht(()=>{const m=a.value-o.value,h=mT*1e3-m;return h>0?Math.ceil(h/1e3):0}),u=Je("");function d(){const m=Date.now(),h=Math.random().toString(36).slice(2,10),y=btoa(`${m}-${h}-${(e.message||"").length}`);return{ts:m,nonce:h,sig:y}}const f=Ht(()=>({majorClass:e.majorClass?"":"请输入你的专业与班级",studentId:e.studentId?"":"请输入学号",name:e.name?"":"请输入姓名",stack:e.stack?e.stack==="其他"&&!e.customStack?.trim()?"请输入自定义优势":"":"请选择优势",message:e.message.length>us?`最多 ${us} 字`:""})),p=Ht(()=>Object.values(f.value).every(m=>!m));async function v(){if(c.value>0){s.value=`请稍后 ${c.value}s 再提交`;return}if(u.value.trim()){r.value=!0,setTimeout(()=>r.value=!1,1500);return}if(Object.keys(t).forEach(m=>t[m]=!0),!!p.value){i.value=!0,s.value="";try{const m=e.stack==="其他"?e.customStack?.trim():e.stack,h=d(),y={majorClass:e.majorClass,studentId:e.studentId,name:e.name,stack:m,message:e.message,meta:h};await new Promise(x=>setTimeout(x,150+Math.random()*300));const S=await fetch(pT,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(y)});if(!S.ok){let x="";try{const C=await S.json();x=C?.error||C?.message||""}catch{}throw new Error(`提交失败(${S.status}) ${x}`)}o.value=Date.now(),localStorage.setItem("join_last_submit",String(o.value)),r.value=!0,setTimeout(()=>r.value=!1,2500),e.majorClass="",e.studentId="",e.name="",e.stack="",e.customStack="",e.message="",Object.keys(t).forEach(x=>t[x]=!1)}catch(m){s.value=m?.message||"提交出错，请稍后再试"}finally{i.value=!1}}}function g(m){t[m]=!0}return(m,h)=>(ne(),ie("div",G1,[R("form",{onSubmit:vn(v,["prevent"]),class:"space-y-5"},[R("div",W1,[R("label",null,[h[21]||(h[21]=it("请不要填写此字段",-1)),Me(R("input",{autocomplete:"off",tabindex:"-1","onUpdate:modelValue":h[0]||(h[0]=y=>u.value=y),class:"pointer-events-none opacity-0"},null,512),[[nn,u.value]])])]),R("div",null,[R("div",X1,[Me(R("input",{"onUpdate:modelValue":h[1]||(h[1]=y=>e.majorClass=y),onFocus:h[2]||(h[2]=y=>g("majorClass")),onBlur:h[3]||(h[3]=y=>g("majorClass")),"aria-invalid":!!(t.majorClass&&f.value.majorClass),placeholder:"专业与班级",inputmode:"text",autocomplete:"organization-title",enterkeyhint:"next",class:"peer w-full rounded-xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-emerald-400/50 focus:ring-2 focus:ring-emerald-400/40 transition text-base px-4 pt-6 pb-2 placeholder-transparent"},null,40,$1),[[nn,e.majorClass,void 0,{trim:!0}]]),h[22]||(h[22]=R("label",{class:"absolute left-4 top-1/2 -translate-y-1/2 text-emerald-100/60 transition-all pointer-events-none peer-focus:top-2 peer-focus:-translate-y-0 peer-focus:text-xs peer-focus:text-emerald-200 peer-not-placeholder-shown:top-2 peer-not-placeholder-shown:-translate-y-0 peer-not-placeholder-shown:text-xs"}," 专业与班级 ",-1))]),t.majorClass&&f.value.majorClass?(ne(),ie("p",j1,ot(f.value.majorClass),1)):dt("",!0)]),R("div",q1,[R("div",null,[R("div",Y1,[Me(R("input",{"onUpdate:modelValue":h[4]||(h[4]=y=>e.studentId=y),onFocus:h[5]||(h[5]=y=>g("studentId")),onBlur:h[6]||(h[6]=y=>g("studentId")),inputmode:"numeric",autocomplete:"on",enterkeyhint:"next",placeholder:"学号",class:"peer w-full rounded-xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-cyan-400/50 focus:ring-2 focus:ring-cyan-400/40 transition text-base px-4 pt-6 pb-2 placeholder-transparent"},null,544),[[nn,e.studentId,void 0,{trim:!0}]]),h[23]||(h[23]=R("label",{class:"absolute left-4 top-1/2 -translate-y-1/2 text-emerald-100/60 transition-all pointer-events-none peer-focus:top-2 peer-focus:-translate-y-0 peer-focus:text-xs peer-focus:text-emerald-200 peer-not-placeholder-shown:top-2 peer-not-placeholder-shown:-translate-y-0 peer-not-placeholder-shown:text-xs"}," 学号 ",-1))]),t.studentId&&f.value.studentId?(ne(),ie("p",K1,ot(f.value.studentId),1)):dt("",!0)]),R("div",null,[R("div",Z1,[Me(R("input",{"onUpdate:modelValue":h[7]||(h[7]=y=>e.name=y),onFocus:h[8]||(h[8]=y=>g("name")),onBlur:h[9]||(h[9]=y=>g("name")),inputmode:"text",autocomplete:"name",autocapitalize:"off",enterkeyhint:"next",placeholder:"姓名",class:"peer w-full rounded-xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-emerald-400/50 focus:ring-2 focus:ring-emerald-400/40 transition text-base px-4 pt-6 pb-2 placeholder-transparent"},null,544),[[nn,e.name,void 0,{trim:!0}]]),h[24]||(h[24]=R("label",{class:"absolute left-4 top-1/2 -translate-y-1/2 text-emerald-100/60 transition-all pointer-events-none peer-focus:top-2 peer-focus:-translate-y-0 peer-focus:text-xs peer-focus:text-emerald-200 peer-not-placeholder-shown:top-2 peer-not-placeholder-shown:-translate-y-0 peer-not-placeholder-shown:text-xs"}," 姓名 ",-1))]),t.name&&f.value.name?(ne(),ie("p",J1,ot(f.value.name),1)):dt("",!0)])]),R("div",null,[h[25]||(h[25]=R("div",{class:"text-sm text-emerald-100/80 mb-2"},"优势点",-1)),R("div",Q1,[R("button",{type:"button",onClick:h[10]||(h[10]=y=>{e.stack="硬件",e.customStack="",g("stack")}),class:At(["px-3 py-3 rounded-xl border transition active:scale-[0.98] text-sm",e.stack==="硬件"?"border-emerald-400/60 bg-emerald-400/15 shadow-[0_0_0_3px_rgba(16,185,129,0.2)]":"border-white/10 bg-white/5 hover:border-emerald-400/30"])}," 硬件 ",2),R("button",{type:"button",onClick:h[11]||(h[11]=y=>{e.stack="软件",e.customStack="",g("stack")}),class:At(["px-3 py-3 rounded-xl border transition active:scale-[0.98] text-sm",e.stack==="软件"?"border-emerald-400/60 bg-emerald-400/15 shadow-[0_0_0_3px_rgba(16,185,129,0.2)]":"border-white/10 bg-white/5 hover:border-emerald-400/30"])}," 软件 ",2),R("button",{type:"button",onClick:h[12]||(h[12]=y=>{e.stack="管理",e.customStack="",g("stack")}),class:At(["px-3 py-3 rounded-xl border transition active:scale-[0.98] text-sm",e.stack==="管理"?"border-emerald-400/60 bg-emerald-400/15 shadow-[0_0_0_3px_rgba(16,185,129,0.2)]":"border-white/10 bg-white/5 hover:border-emerald-400/30"])}," 管理 ",2),e.stack!=="其他"?(ne(),ie("button",{key:0,type:"button",onClick:h[13]||(h[13]=y=>{e.stack="其他",g("stack")}),class:At(["px-3 py-3 rounded-xl border transition active:scale-[0.98] text-sm col-span-3",e.stack==="其他"?"border-emerald-400/60 bg-emerald-400/15 shadow-[0_0_0_3px_rgba(16,185,129,0.2)]":"border-white/10 bg-white/5 hover:border-emerald-400/30"])}," 其他（点击填写） ",2)):dt("",!0),e.stack==="其他"?(ne(),ie("div",eT,[Me(R("input",{"onUpdate:modelValue":h[14]||(h[14]=y=>e.customStack=y),onFocus:h[15]||(h[15]=y=>{g("stack"),t.customStack=!0}),onBlur:h[16]||(h[16]=y=>g("stack")),maxlength:"20",placeholder:"请输入你的自定义优势 (20字内)",class:"peer w-full rounded-xl bg-white/5 border border-emerald-400/60 text-white focus:outline-none focus:border-emerald-400/70 focus:ring-2 focus:ring-emerald-400/30 transition text-base pl-4 pr-14 py-3 shadow-[0_0_0_3px_rgba(16,185,129,0.15)]"},null,544),[[nn,e.customStack,void 0,{trim:!0}]]),R("button",{type:"button","aria-label":"取消自定义",onClick:h[17]||(h[17]=y=>{e.stack="",e.customStack="",g("stack")}),class:"absolute top-1/2 -translate-y-1/2 right-2 w-8 h-8 rounded-md bg-white/10 hover:bg-white/15 flex items-center justify-center text-emerald-100/80 leading-none active:scale-[0.95]"}," ✕ "),R("div",tT,ot(e.customStack?.length||0)+"/20",1)])):dt("",!0)]),t.stack&&f.value.stack?(ne(),ie("p",nT,ot(f.value.stack),1)):dt("",!0)]),R("div",null,[R("div",iT,[Me(R("textarea",{"onUpdate:modelValue":h[18]||(h[18]=y=>e.message=y),onFocus:h[19]||(h[19]=y=>g("message")),onBlur:h[20]||(h[20]=y=>g("message")),maxlength:us+20,rows:"5",inputmode:"text",enterkeyhint:"send",placeholder:"想说的话",class:"peer w-full rounded-xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-cyan-400/50 focus:ring-2 focus:ring-cyan-400/40 transition text-base px-4 pt-7 pb-3 resize-none placeholder-transparent"},null,40,rT),[[nn,e.message]]),h[26]||(h[26]=R("label",{class:"absolute left-4 top-4 text-emerald-100/60 transition-all pointer-events-none peer-focus:top-2 peer-focus:text-xs peer-focus:text-emerald-200 peer-not-placeholder-shown:top-2 peer-not-placeholder-shown:text-xs"}," 想说的话 ",-1)),R("div",sT,[R("div",oT,[R("div",{class:"h-full bg-gradient-to-r from-emerald-400 to-cyan-400",style:ai({width:Math.min(100,Math.round(e.message.length/us*100))+"%"})},null,4)]),R("span",aT,ot(e.message.length)+" / "+ot(us),1)])]),t.message&&f.value.message?(ne(),ie("p",lT,ot(f.value.message),1)):dt("",!0)]),R("button",{disabled:i.value||!p.value||c.value>0,onClick:vn(v,["prevent"]),class:"w-full py-4 rounded-xl font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-r from-emerald-500 to-cyan-500 text-black shadow-[0_10px_30px_-10px_rgba(16,185,129,0.6)] active:scale-[0.99]",style:{"margin-bottom":"calc(env(safe-area-inset-bottom) + 8px)"}},[c.value>0?(ne(),ie("span",uT,"冷却 "+ot(c.value)+"s…",1)):(ne(),ie("span",dT,ot(i.value?"提交中…":"提交报名"),1))],8,cT),h[27]||(h[27]=R("p",{class:"text-center text-xs text-emerald-100/60"},"提交后请耐心等待 静候开学后相关通知",-1)),s.value?(ne(),ie("p",fT,ot(s.value),1)):dt("",!0)],32),r.value?(ne(),ie("div",hT," 提交成功，感谢支持！ ")):dt("",!0)]))}}),vT=Gn(gT,[["__scopeId","data-v-bd594de0"]]),_T=24,xT=Jt({__name:"JoinGlow",props:{active:{type:Boolean},burstKey:{}},setup(n){const e=n,t=Je(null);let i=0,r=null,s=0,o=0,a=Math.min(window.devicePixelRatio||1,2),l=!1,c=[],u=[];function d(S,x){return Math.random()*(x-S)+S}function f(){const S=t.value,x=S.getBoundingClientRect();s=Math.floor(x.width),o=Math.floor(x.height),a=Math.min(window.devicePixelRatio||1,2),S.width=Math.max(1,Math.floor(s*a)),S.height=Math.max(1,Math.floor(o*a)),r=S.getContext("2d"),r&&r.setTransform(a,0,0,a,0,0)}function p(){const S=Math.floor(_T*Math.min(1.5,Math.max(.8,s*o/304200)));c=Array.from({length:S},()=>({x:d(0,s),y:d(0,o),vx:d(-.12,.12),vy:d(-.12,.12),r:d(.6,1.8),hue:d(150,210),alpha:d(.25,.6)}))}function v(){const S=s/2,x=Math.min(o*.45,o-80);u.push(...Array.from({length:90},()=>{const L=d(0,Math.PI*2),D=d(.6,2.2);return{x:S+d(-10,10),y:x+d(-10,10),vx:Math.cos(L)*D,vy:Math.sin(L)*D-d(.2,.6),r:d(1.2,2.6),hue:d(140,220),life:0,maxLife:d(42,70)}}))}function g(){if(!r)return;const S=r.createRadialGradient(s/2,o/2,0,s/2,o/2,Math.max(s,o)*.7);S.addColorStop(0,"rgba(16,255,192,0.04)"),S.addColorStop(1,"rgba(0,0,0,0)"),r.fillStyle=S,r.fillRect(0,0,s,o)}function m(){if(r){r.fillStyle="rgba(0,0,0,0.35)",r.fillRect(0,0,s,o),g();for(const S of c)S.x+=S.vx,S.y+=S.vy,S.x<-10&&(S.x=s+10),S.x>s+10&&(S.x=-10),S.y<-10&&(S.y=o+10),S.y>o+10&&(S.y=-10),r.beginPath(),r.fillStyle=`hsla(${S.hue}, 80%, 70%, ${S.alpha})`,r.arc(S.x,S.y,S.r,0,Math.PI*2),r.fill();for(let S=u.length-1;S>=0;S--){const x=u[S];x.life+=1,x.x+=x.vx,x.y+=x.vy,x.vy+=.02;const C=1-x.life/x.maxLife;r.beginPath(),r.fillStyle=`hsla(${x.hue}, 90%, 70%, ${Math.max(0,C)})`,r.arc(x.x,x.y,x.r*(.8+.4*C),0,Math.PI*2),r.fill(),x.life>=x.maxLife&&u.splice(S,1)}l&&(i=requestAnimationFrame(m))}}function h(){l||(l=!0,f(),p(),r?.clearRect(0,0,s,o),i=requestAnimationFrame(m))}function y(){l=!1,cancelAnimationFrame(i)}return gi(()=>{const S=()=>{f(),p()};window.addEventListener("resize",S),zm(()=>{e.active?h():y()}),cr(()=>e.burstKey,()=>{e.active&&(u.splice(0,u.length),v())})}),Bi(()=>{y(),window.removeEventListener("resize",f)}),(S,x)=>(ne(),ie("canvas",{ref_key:"canvasRef",ref:t,class:"absolute inset-0 w-full h-full pointer-events-none select-none"},null,512))}}),bT={class:"relative z-10 w-full max-w-screen-md mx-auto text-center"},yT={class:"text-lg sm:text-xl mt-3 text-white font-semibold",reveal:{delay:120}},ST={class:"mt-3 sm:mt-4 text-sm sm:text-base text-emerald-100/80 max-w-md mx-auto px-1",reveal:{delay:200}},MT={class:"mt-1 text-xs sm:text-sm text-emerald-100/70 max-w-md mx-auto px-1",reveal:{delay:220}},ET={class:"mt-6 sm:mt-8 flex items-center justify-center gap-4 sm:gap-6",reveal:{delay:260}},TT={class:"relative z-10 mt-9 sm:mt-12",reveal:{delay:340}},wT=Jt({__name:"JoinUsSection",setup(n){const e=Je(null),t=Je(!1),i=Je(0);let r=null;return gi(()=>{r=new IntersectionObserver(s=>{const o=s[0];o&&(o.isIntersecting?(t.value=!0,i.value++):t.value=!1)},{threshold:.35}),e.value&&r.observe(e.value)}),Bi(()=>{r?.disconnect(),r=null}),(s,o)=>{const a=fi("reveal");return Me((ne(),ie("div",{id:"join",ref_key:"joinRef",ref:e,class:"relative px-4 sm:px-5 py-16 sm:py-20 overflow-hidden cv-auto"},[rt(xT,{active:t.value,"burst-key":i.value},null,8,["active","burst-key"]),Me((ne(),ie("div",bT,[o[4]||(o[4]=R("h2",{class:"text-3xl sm:text-4xl font-extrabold tracking-tight drop-shadow-[0_0_20px_rgba(16,185,129,0.35)]"},[it(" 加入我们，"),R("span",{class:"text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-cyan-300"},"一起"),it("把灵感上线 ")],-1)),Me((ne(),ie("p",yT,[...o[0]||(o[0]=[it("让知识开花",-1)])])),[[a,void 0,'"up"']]),Me((ne(),ie("p",ST,[...o[1]||(o[1]=[it("扫码进群 / 关注学校官方通知",-1)])])),[[a,void 0,'"fade"']]),Me((ne(),ie("p",MT,[...o[2]||(o[2]=[it("或者在下面的表格留个名，我们会多关照哦",-1)])])),[[a,void 0,'"fade"']]),Me((ne(),ie("div",ET,[...o[3]||(o[3]=[kt('<div class="flex flex-col items-center"><div class="relative group"><div class="p-[2px] rounded-2xl bg-[linear-gradient(140deg,rgba(255,255,255,0.85),rgba(255,255,255,0.55),rgba(255,255,255,0.78))] shadow-[0_0_0_1px_rgba(255,255,255,0.35),0_0_22px_4px_rgba(255,255,255,0.55),0_6px_28px_-8px_rgba(16,185,129,0.25)]"><div class="size-24 sm:size-28 rounded-xl overflow-hidden bg-white relative"><img src="'+H1+'" alt="官方迎新群二维码" class="w-full h-full object-cover transition duration-500 group-hover:scale-[1.015]" decoding="async" loading="lazy"><div class="pointer-events-none absolute inset-0 ring-1 ring-black/5"></div><div class="pointer-events-none absolute inset-0 rounded-xl mix-blend-overlay opacity-60 bg-[radial-gradient(circle_at_25%_30%,rgba(16,185,129,0.18),transparent_55%),radial-gradient(circle_at_75%_70%,rgba(34,211,238,0.16),transparent_60%)]"></div></div></div><div class="pointer-events-none absolute -inset-2 rounded-2xl opacity-0 group-hover:opacity-100 transition duration-500 blur-xl bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.45),transparent_70%)]"></div></div><div class="mt-2 text-[10px] sm:text-xs text-emerald-100/80 tracking-wide">官方迎新群</div></div><div class="flex flex-col items-center"><div class="relative group"><div class="p-[2.5px] rounded-2xl bg-gradient-to-tr from-cyan-400/80 via-emerald-400/60 to-white/70 shadow-[0_0_0_1px_rgba(34,211,238,0.25),0_0_22px_4px_rgba(34,211,238,0.18),0_6px_28px_-8px_rgba(16,185,129,0.18)]"><div class="size-24 sm:size-28 rounded-xl overflow-hidden bg-white relative"><img src="'+V1+'" alt="官Q二维码" class="w-full h-full object-cover transition duration-500 group-hover:scale-[1.03]" decoding="async" loading="lazy"><div class="pointer-events-none absolute inset-0 ring-1 ring-cyan-400/10"></div><div class="pointer-events-none absolute inset-0 rounded-xl mix-blend-overlay opacity-70 bg-[radial-gradient(circle_at_25%_30%,rgba(34,211,238,0.18),transparent_55%),radial-gradient(circle_at_75%_70%,rgba(16,185,129,0.14),transparent_60%)]"></div></div></div><div class="pointer-events-none absolute -inset-3 rounded-2xl opacity-80 group-hover:opacity-100 transition duration-500 blur-2xl bg-[radial-gradient(circle_at_50%_50%,rgba(34,211,238,0.55),rgba(16,185,129,0.25),transparent_80%)]"></div></div><div class="mt-2 text-[10px] sm:text-xs text-cyan-200/80 tracking-wide font-semibold">电子俱乐部官方QQ</div></div>',2)])])),[[a,void 0,'"pop"']])])),[[a,void 0,'"pop"']]),Me((ne(),ie("div",TT,[rt(vT)])),[[a,void 0,'"pop"']])])),[[a]])}}}),AT={class:"fixed bottom-[calc(env(safe-area-inset-bottom)+16px)] right-4 z-50 flex flex-col items-end gap-3"},RT={key:0},CT={key:1},PT=Jt({__name:"FloatingUI",setup(n){const e=Je(!1),t=Je(!1),i=Je(!1);let r=null;function s(){const l=document.documentElement.scrollTop||document.body.scrollTop;e.value=l>240}function o(){if(r=window.__bgm||null,!r){t.value=!1;return}t.value=!0,r.paused?r.play().then(()=>{i.value=!0}).catch(()=>{}):(r.pause(),i.value=!1)}gi(()=>{window.addEventListener("scroll",s,{passive:!0}),s(),r=window.__bgm||null,t.value=!!r,r?r.play().then(()=>{i.value=!0}).catch(()=>{i.value=!1}):i.value=!1}),Bi(()=>{window.removeEventListener("scroll",s)});function a(){window.scrollTo({top:0,behavior:"smooth"})}return(l,c)=>(ne(),ie("div",AT,[t.value?(ne(),ie("button",{key:0,onClick:o,class:"relative w-12 h-12 flex items-center justify-center p-0 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-md text-white shadow-lg active:scale-95 transition"},[i.value?(ne(),ie("span",RT,"🔊")):(ne(),ie("span",CT,"🔈"))])):dt("",!0),Me(R("button",{onClick:a,class:"relative w-12 h-12 flex items-center justify-center p-0 rounded-full bg-gradient-to-tr from-emerald-400/90 to-cyan-400/90 text-black font-bold shadow-lg active:scale-95 transition border border-white/20"}," ↑ ",512),[[Th,e.value]])]))}}),DT={class:"relative text-white scroll-smooth overflow-hidden bg-gradient-to-b from-emerald-950 via-slate-950 to-black"},LT={class:"relative z-20 text-white"},IT=Jt({__name:"ClubPoster",setup(n){return(e,t)=>(ne(),ie("section",DT,[t[0]||(t[0]=kt('<div aria-hidden="true" class="pointer-events-none absolute inset-0 z-0" data-v-d871c9fd><div class="absolute -top-[60vh] -left-[50vw] w-[160vw] h-[160vh] rounded-full bg-emerald-400/35 blur-[200px] opacity-40" style="will-change:transform, opacity;" data-v-d871c9fd></div><div class="absolute top-[20vh] -right-[60vw] w-[140vw] h-[140vh] rounded-full bg-cyan-400/35 blur-[200px] opacity-30" style="will-change:transform, opacity;" data-v-d871c9fd></div><div class="absolute bottom-[-50vh] left-[-20vw] w-[130vw] h-[130vh] rounded-full bg-emerald-300/30 blur-[200px] opacity-50" style="will-change:transform, opacity;" data-v-d871c9fd></div><div class="absolute inset-x-0 top-[-10vh] h-[100vh] bg-[linear-gradient(120deg,rgba(16,185,129,0)_0%,rgba(16,185,129,0.45)_40%,rgba(34,211,238,0.45)_60%,rgba(34,211,238,0)_100%)] opacity-20 blur-2xl" style="will-change:transform, opacity;" data-v-d871c9fd></div><div class="absolute inset-x-0 top-[60vh] h-[100vh] bg-[linear-gradient(120deg,rgba(16,185,129,0)_0%,rgba(34,211,238,0.4)_50%,rgba(16,185,129,0)_100%)] opacity-15 blur-2xl" style="will-change:transform, opacity;" data-v-d871c9fd></div><div class="absolute inset-x-0 top-[140vh] h-[100vh] bg-[linear-gradient(120deg,rgba(16,185,129,0)_0%,rgba(34,211,238,0.35)_50%,rgba(16,185,129,0)_100%)] opacity-10 blur-2xl" style="will-change:transform, opacity;" data-v-d871c9fd></div></div>',1)),R("div",LT,[rt(PT),rt(cE),rt(DE),rt(YE),rt(r1),rt(g1),rt(E1),rt(z1),rt(wT)])]))}}),UT=Gn(IT,[["__scopeId","data-v-d871c9fd"]]),NT="/led1.jpg",FT="/led2.jpg",OT="/led3.jpg",BT="/purchase.jpg",kT="/example.jpg",zT={class:"min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 text-slate-800 font-sans overflow-hidden"},HT={class:"fixed inset-0 z-0 pointer-events-none"},VT={class:"absolute inset-0 opacity-5"},GT={class:"grid grid-cols-20 grid-rows-20 h-full w-full"},WT={class:"relative z-10 container mx-auto px-4 py-6 sm:py-8 max-w-6xl"},XT={class:"fixed bottom-[calc(env(safe-area-inset-bottom)+16px)] right-4 z-50"},$T={class:"mb-12 sm:mb-20 text-center relative"},jT={class:"max-w-3xl mx-auto"},qT={class:"flex justify-center mb-6 sm:mb-8"},YT={class:"flex gap-1 p-3 sm:p-4 bg-white/70 rounded-full border border-slate-200 backdrop-blur-sm shadow-sm"},KT={class:"mb-12 sm:mb-16",id:"register"},ZT={class:"bg-gradient-to-br from-white via-slate-50 to-sky-50 border border-slate-200 rounded-2xl sm:rounded-3xl p-6 sm:p-10 backdrop-blur-xl relative overflow-hidden shadow-lg"},JT={class:"relative z-10"},QT={key:0,class:"text-center mb-6 sm:mb-10"},ew={key:1,class:"max-w-2xl mx-auto space-y-6"},tw={class:"space-y-3 sm:space-y-4"},nw={class:"space-y-2"},iw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},rw={class:"grid sm:grid-cols-2 gap-4 sm:gap-6"},sw={class:"space-y-2"},ow={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},aw={class:"space-y-2"},lw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},cw={class:"grid sm:grid-cols-2 gap-4 sm:gap-6"},uw={class:"space-y-2"},dw={class:"grid grid-cols-4 gap-2"},fw=["onClick"],hw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},pw={class:"space-y-2"},mw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},gw={class:"space-y-4"},vw={class:"flex items-center justify-between gap-2 text-sm text-slate-700"},_w=["disabled"],xw={class:"space-y-3"},bw={class:"flex items-center justify-between text-xs text-emerald-700"},yw=["onClick"],Sw={class:"grid sm:grid-cols-2 gap-3"},Mw={class:"space-y-1.5"},Ew=["onUpdate:modelValue","onInput"],Tw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},ww={class:"space-y-1.5"},Aw=["onUpdate:modelValue","onInput"],Rw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},Cw={class:"grid sm:grid-cols-2 gap-3"},Pw={class:"space-y-1.5"},Dw={class:"grid grid-cols-4 gap-1.5"},Lw=["onClick"],Iw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},Uw={class:"space-y-1.5"},Nw=["onUpdate:modelValue","onInput"],Fw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},Ow={class:"space-y-3 sm:space-y-4"},Bw={class:"space-y-2"},kw={key:0,class:"text-red-500 text-xs mt-1 block ml-1"},zw={key:2,class:"max-w-4xl mx-auto animate-fade-in"},Hw={key:0,class:"text-center max-w-md mx-auto mb-8"},Vw={key:1,class:"text-center max-w-4xl mx-auto"},Gw={class:"flex flex-col gap-4"},Ww={key:0,class:"bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl text-sm flex items-start gap-2 animate-fade-in"},Xw=["disabled"],$w={key:0,class:"relative z-10"},jw={key:1,class:"relative z-10"},qw={class:"flex flex-col sm:flex-row gap-4 justify-center items-center"},Yw={class:"fixed inset-0 pointer-events-none z-0"},Kw=Jt({__name:"LedCompetitionView",setup(n){const e=rv(),t=Je({teamName:"",leaderName:"",leaderStudentId:"",leaderGrade:"",leaderMajorClass:"",contact:"",note:"",members:[]}),i=Je(1),r=Je(!1),s=Je(!1),o=Je(!1),a=Je(""),l=Je({teamName:"",leaderName:"",leaderStudentId:"",leaderGrade:"",leaderMajorClass:"",contact:"",members:[]});function c(){l.value={teamName:"",leaderName:"",leaderStudentId:"",leaderGrade:"",leaderMajorClass:"",contact:"",members:t.value.members.map(()=>({name:"",studentId:"",grade:"",majorClass:""}))};let h=!1;t.value.teamName||(l.value.teamName="请输入队伍名称",h=!0),t.value.leaderName||(l.value.leaderName="请输入队长姓名",h=!0);const y=x=>/^\d+$/.test(x),S=x=>/^[\u4e00-\u9fa5\d\s-]+$/.test(x);if(t.value.leaderStudentId?y(t.value.leaderStudentId)||(l.value.leaderStudentId="队长学号必须为纯数字",h=!0):(l.value.leaderStudentId="请输入队长学号",h=!0),t.value.leaderGrade||(l.value.leaderGrade="请选择队长年级",h=!0),t.value.leaderMajorClass?S(t.value.leaderMajorClass)||(l.value.leaderMajorClass="专业班级应为中文、数字或 - 的组合",h=!0):(l.value.leaderMajorClass="请输入队长专业与班级",h=!0),t.value.contact?y(t.value.contact)||(l.value.contact="联系方式必须为纯数字",h=!0):(l.value.contact="请输入联系方式",h=!0),t.value.members.forEach((x,C)=>{const L=x.name||x.studentId||x.grade||x.majorClass,D=x.name&&x.studentId&&x.grade&&x.majorClass;L&&!D&&(x.name||(l.value.members[C].name="请补全姓名"),x.studentId||(l.value.members[C].studentId="请补全学号"),x.grade||(l.value.members[C].grade="请选择年级"),x.majorClass||(l.value.members[C].majorClass="请补全专业班级"),h=!0),D&&(y(x.studentId)||(l.value.members[C].studentId="学号必须为纯数字",h=!0),S(x.majorClass)||(l.value.members[C].majorClass="专业班级应为中文、数字或 - 的组合",h=!0))}),h){setTimeout(()=>{const x=document.querySelector(".text-red-500");x&&x.scrollIntoView({behavior:"smooth",block:"center"})},100);return}i.value=2}async function u(){if(!(s.value||i.value!==2)){s.value=!0,a.value="";try{const h={isLed:!0,teamName:t.value.teamName,leaderName:t.value.leaderName,leaderStudentId:t.value.leaderStudentId,leaderGrade:t.value.leaderGrade,leaderMajorClass:t.value.leaderMajorClass,contact:t.value.contact,members:t.value.members.filter(S=>S.name&&S.studentId),note:t.value.note||"",meta:{timestamp:new Date().toISOString(),status:"paid",submitFrom:"led-competition-view"}},y=await fetch("https://eclubapi.kitramgp.cn/api/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(h)});if(y.ok)o.value=!0,setTimeout(()=>{p()},3e3);else{const S=await y.json().catch(()=>({message:"未知错误"}));throw new Error(S.message||"提交失败")}}catch(h){console.error("上传失败：",h),a.value=h.message||"网络错误，请稍后重试"}finally{s.value=!1}}}function d(){t.value.members.length>=2||(t.value.members.push({name:"",studentId:"",grade:"",majorClass:""}),l.value.members.push({name:"",studentId:"",grade:"",majorClass:""}))}function f(h){t.value.members.splice(h,1),l.value.members.splice(h,1)}function p(){e.push("/")}const v=Je(!1);function g(){const h=document.documentElement.scrollTop||document.body.scrollTop;v.value=h>240}function m(){window.scrollTo({top:0,behavior:"smooth"})}return gi(()=>{setTimeout(()=>{r.value=!0},100),window.addEventListener("scroll",g,{passive:!0}),g()}),Bi(()=>{window.removeEventListener("scroll",g)}),(h,y)=>(ne(),ie("div",zT,[R("div",HT,[R("div",VT,[R("div",GT,[(ne(),ie(Mt,null,En(400,S=>R("div",{key:S,class:"border border-slate-300/20 relative overflow-hidden"},[R("div",{class:"absolute inset-0 bg-slate-200/10 animate-pulse",style:ai(`animation-delay: ${Math.random()*3}s; animation-duration: ${2+Math.random()*4}s`)},null,4)])),64))])]),y[11]||(y[11]=kt('<div class="absolute top-1/4 left-1/4 w-64 h-64 opacity-3" data-v-ac00a8b8><svg class="w-full h-full" viewBox="0 0 200 200" data-v-ac00a8b8><path d="M20,20 L180,20 L180,180 L20,180 Z" stroke="url(#circuit-gradient-light)" stroke-width="1" fill="none" data-v-ac00a8b8></path><circle cx="50" cy="50" r="2" fill="#0ea5e9" class="animate-pulse" data-v-ac00a8b8></circle><circle cx="150" cy="150" r="2" fill="#10b981" class="animate-pulse" data-v-ac00a8b8></circle><path d="M50,50 L100,100 L150,150" stroke="url(#circuit-gradient-light)" stroke-width="0.5" fill="none" data-v-ac00a8b8></path><defs data-v-ac00a8b8><linearGradient id="circuit-gradient-light" x1="0%" y1="0%" x2="100%" y2="100%" data-v-ac00a8b8><stop offset="0%" stop-color="#0ea5e9" data-v-ac00a8b8></stop><stop offset="100%" stop-color="#10b981" data-v-ac00a8b8></stop></linearGradient></defs></svg></div><div class="absolute top-1/3 right-1/4 w-32 h-32 bg-sky-200/20 blur-[60px] rounded-full animate-pulse" data-v-ac00a8b8></div><div class="absolute bottom-1/4 left-1/3 w-40 h-40 bg-emerald-200/15 blur-[80px] rounded-full animate-pulse" style="animation-delay:2s;" data-v-ac00a8b8></div>',3))]),R("div",WT,[R("div",XT,[Me(R("button",{onClick:m,class:"relative w-12 h-12 flex items-center justify-center p-0 rounded-full bg-gradient-to-tr from-sky-400/90 to-emerald-400/90 text-white font-bold shadow-lg active:scale-95 transition border border-white/20 backdrop-blur-md"}," ↑ ",512),[[Th,v.value]])]),R("header",{class:"flex justify-between items-center mb-8 sm:mb-16"},[R("button",{onClick:p,class:"group text-sky-600 hover:text-sky-700 flex items-center gap-2 transition-all duration-300 backdrop-blur-sm bg-white/80 px-4 py-2 rounded-full border border-slate-200 hover:border-sky-300 cursor-pointer shadow-sm"},[...y[12]||(y[12]=[R("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-5 w-5 group-hover:-translate-x-1 transition-transform",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[R("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 19l-7-7m0 0l7-7m-7 7h18"})],-1),it(" 返回首页 ",-1)])]),y[13]||(y[13]=R("div",{class:"text-lg sm:text-xl font-bold tracking-wider bg-gradient-to-r from-sky-600 to-emerald-600 bg-clip-text text-transparent"}," 电子俱乐部·比赛专区 ",-1))]),R("section",$T,[y[15]||(y[15]=kt('<div class="relative inline-block" data-v-ac00a8b8><div class="absolute -inset-8 bg-gradient-to-r from-emerald-600/20 to-cyan-600/20 blur-2xl rounded-full" data-v-ac00a8b8></div><h1 class="text-4xl sm:text-5xl md:text-7xl font-black mb-4 sm:mb-6 relative" data-v-ac00a8b8><span class="block transform hover:scale-105 transition-transform duration-500 bg-gradient-to-b from-slate-800 via-slate-700 to-slate-600 bg-clip-text text-transparent" data-v-ac00a8b8> LED 创意大赛 </span><span class="block text-xl sm:text-2xl md:text-5xl mt-1 sm:mt-2 bg-gradient-to-r from-sky-600 to-emerald-600 bg-clip-text text-transparent" data-v-ac00a8b8> 技术实战 创意比拼 </span></h1></div>',1)),R("div",jT,[y[14]||(y[14]=kt('<p class="text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed mb-6 sm:mb-8 transform hover:scale-105 transition-transform duration-300" data-v-ac00a8b8> 一场校级认证的创意盛宴，无需深厚背景。点亮你的第一个LED作品，即可轻松赢取丰厚大奖与官方荣誉。我们提供全面的赛前培训，0基础也能快速上手！ </p><div class="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto mb-6 sm:mb-8" data-v-ac00a8b8><div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-slate-200 text-center hover:transform hover:scale-105 transition-all duration-300" data-v-ac00a8b8><div class="text-sky-600 font-bold text-lg mb-1" data-v-ac00a8b8>比赛时间</div><div class="text-slate-700 text-sm" data-v-ac00a8b8>2025年12月7日</div><div class="text-slate-600 text-xs mt-1" data-v-ac00a8b8>上午9:00-11:00 | 下午14:00-16:00</div></div><div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-slate-200 text-center hover:transform hover:scale-105 transition-all duration-300" data-v-ac00a8b8><div class="text-emerald-600 font-bold text-lg mb-1" data-v-ac00a8b8>比赛地点</div><div class="text-slate-700 text-sm" data-v-ac00a8b8>信息楼一二合班</div></div><div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-slate-200 text-center hover:transform hover:scale-105 transition-all duration-300" data-v-ac00a8b8><div class="text-violet-600 font-bold text-lg mb-1" data-v-ac00a8b8>组队要求</div><div class="text-slate-700 text-sm" data-v-ac00a8b8>2-3人组队</div><div class="text-slate-600 text-xs mt-1" data-v-ac00a8b8>报名费21元/队</div></div></div>',2)),R("div",qT,[R("div",YT,[(ne(),ie(Mt,null,En(12,S=>R("div",{key:S,class:At(["w-2 h-6 sm:w-3 sm:h-8 rounded-full animate-pulse",S%3===0?"bg-emerald-500":S%3===1?"bg-cyan-500":"bg-blue-500"]),style:ai(`animation-delay: ${S*.1}s`)},null,6)),64))])])])]),y[39]||(y[39]=kt('<section class="mb-12 sm:mb-20" data-v-ac00a8b8><div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6" data-v-ac00a8b8><div class="group bg-gradient-to-br from-sky-50 to-white border border-sky-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:border-sky-300 transition-all duration-300 hover:transform hover:scale-105 shadow-sm" data-v-ac00a8b8><div class="w-10 h-10 sm:w-12 sm:h-12 bg-sky-100 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-sky-200 transition-colors" data-v-ac00a8b8><svg class="w-5 h-5 sm:w-6 sm:h-6 text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac00a8b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" data-v-ac00a8b8></path></svg></div><h3 class="text-lg sm:text-xl font-bold text-sky-700 mb-1 sm:mb-2" data-v-ac00a8b8>零基础友好</h3><p class="text-slate-600 text-sm" data-v-ac00a8b8>无需复杂背景，我们提供&quot;重量级&quot;赛前培训+完整材料包（LED灯、洞洞板、电烙铁等），带你从0到1亲手实践，体验点亮LED的纯粹乐趣。</p></div><div class="group bg-gradient-to-br from-amber-50 to-white border border-amber-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:border-amber-300 transition-all duration-300 hover:transform hover:scale-105 shadow-sm" data-v-ac00a8b8><div class="w-10 h-10 sm:w-12 sm:h-12 bg-amber-100 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-amber-200 transition-colors" data-v-ac00a8b8><svg class="w-5 h-5 sm:w-6 sm:h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac00a8b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" data-v-ac00a8b8></path></svg></div><h3 class="text-lg sm:text-xl font-bold text-amber-700 mb-1 sm:mb-2" data-v-ac00a8b8>创意至上</h3><p class="text-slate-600 text-sm" data-v-ac00a8b8>现场焊接，当场编码，让LED作品肆意闪烁。评分核心是&quot;创意&quot;，你的想象力是唯一限制。优秀作品将在校园科技节展出，不予返还。</p></div><div class="group bg-gradient-to-br from-violet-50 to-white border border-violet-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:border-violet-300 transition-all duration-300 hover:transform hover:scale-105 shadow-sm" data-v-ac00a8b8><div class="w-10 h-10 sm:w-12 sm:h-12 bg-violet-100 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-violet-200 transition-colors" data-v-ac00a8b8><svg class="w-5 h-5 sm:w-6 sm:h-6 text-violet-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac00a8b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-ac00a8b8></path></svg></div><h3 class="text-lg sm:text-xl font-bold text-violet-700 mb-1 sm:mb-2" data-v-ac00a8b8>校级荣誉+重磅奖品</h3><p class="text-slate-600 text-sm" data-v-ac00a8b8>校级证书为你的履历加分！一等奖无人机，二等奖精美水杯，三等奖手机支架，满载而归。报名费21元/队，性价比超高。</p></div></div></section><div class="grid md:grid-cols-2 gap-8 mb-20" data-v-ac00a8b8><div class="group bg-gradient-to-br from-white to-slate-50 border border-slate-200 rounded-3xl p-8 backdrop-blur-md hover:border-sky-300 transition-all duration-500 shadow-sm" data-v-ac00a8b8><div class="flex items-center mb-6" data-v-ac00a8b8><div class="w-1 h-10 bg-gradient-to-b from-sky-500 to-emerald-500 rounded-full mr-4" data-v-ac00a8b8></div><h2 class="text-3xl font-bold bg-gradient-to-r from-sky-600 to-emerald-600 bg-clip-text text-transparent" data-v-ac00a8b8> 比赛规则 </h2></div><div class="space-y-6" data-v-ac00a8b8><div class="relative pl-6 border-l-2 border-sky-500/30" data-v-ac00a8b8><div class="absolute -left-2 top-2 w-3 h-3 bg-sky-500 rounded-full" data-v-ac00a8b8></div><div class="text-slate-800 font-semibold mb-2" data-v-ac00a8b8>赛程安排</div><p class="text-slate-600 leading-relaxed text-sm" data-v-ac00a8b8>比赛分为上午场（9:00-11:00）与下午场（14:00-16:00），参赛队伍可任选一场参与。每场比赛包含两个计分环节，需依次完成公共赛题与自由创作，两部分成绩总和为最终得分。</p></div><div class="relative pl-6 border-l-2 border-emerald-500/30" data-v-ac00a8b8><div class="absolute -left-2 top-2 w-3 h-3 bg-emerald-500 rounded-full" data-v-ac00a8b8></div><div class="text-slate-800 font-semibold mb-2" data-v-ac00a8b8>公共赛题（第一部分）</div><p class="text-slate-600 leading-relaxed text-sm" data-v-ac00a8b8>现场提供标准化开发板，大一新生使用STC51单片机，大二学生使用STM32开发板，需在限定时间内编程实现指定LED动态效果。此环节检验基础电路设计与代码实现能力。</p></div><div class="relative pl-6 border-l-2 border-cyan-500/30" data-v-ac00a8b8><div class="absolute -left-2 top-2 w-3 h-3 bg-cyan-500 rounded-full" data-v-ac00a8b8></div><div class="text-slate-800 font-semibold mb-2" data-v-ac00a8b8>自由创作（第二部分）</div><p class="text-slate-600 leading-relaxed text-sm" data-v-ac00a8b8>选手可携带洞洞板、自制PCB或个人开发板进行创意设计。此环节鼓励技术融合与创新思维。</p></div><div class="bg-gradient-to-r from-sky-50 to-emerald-50 rounded-2xl p-6 border border-sky-200 mt-6" data-v-ac00a8b8><p class="text-sky-800 font-semibold text-lg mb-2" data-v-ac00a8b8>评分标准</p><p class="text-sm text-sky-700" data-v-ac00a8b8>综合评定技术实现能力和创意水平。</p></div></div></div><div class="group bg-gradient-to-br from-white to-slate-50 border border-slate-200 rounded-3xl p-8 backdrop-blur-md hover:border-emerald-300 transition-all duration-500 shadow-sm" data-v-ac00a8b8><div class="flex items-center mb-6" data-v-ac00a8b8><div class="w-1 h-10 bg-gradient-to-b from-emerald-500 to-sky-500 rounded-full mr-4" data-v-ac00a8b8></div><h2 class="text-3xl font-bold bg-gradient-to-r from-emerald-600 to-sky-600 bg-clip-text text-transparent" data-v-ac00a8b8> 比赛内容 </h2></div><div class="space-y-6" data-v-ac00a8b8><div class="group/item bg-gradient-to-r from-emerald-50 to-sky-50 rounded-xl p-5 border border-emerald-200 hover:border-emerald-300 transition-all duration-300" data-v-ac00a8b8><div class="flex items-start gap-4" data-v-ac00a8b8><div class="bg-gradient-to-br from-emerald-500 to-sky-500 text-white px-3 py-1 rounded-lg font-mono text-sm font-bold" data-v-ac00a8b8> 公共赛题 </div><div class="flex-1" data-v-ac00a8b8><h3 class="font-bold text-slate-800 text-lg mb-2" data-v-ac00a8b8>基础能力考核</h3><p class="text-slate-600 text-sm leading-relaxed mb-3" data-v-ac00a8b8>在限定时间内完成电路连接与代码调试，按要求实现指定LED效果。检验选手的基础编程和电路设计能力。</p></div></div></div><div class="group/item bg-gradient-to-r from-sky-50 to-violet-50 rounded-xl p-5 border border-sky-200 hover:border-sky-300 transition-all duration-300" data-v-ac00a8b8><div class="flex items-start gap-4" data-v-ac00a8b8><div class="bg-gradient-to-br from-sky-500 to-violet-500 text-white px-3 py-1 rounded-lg font-mono text-sm font-bold" data-v-ac00a8b8> 自由创作 </div><div class="flex-1" data-v-ac00a8b8><h3 class="font-bold text-slate-800 text-lg mb-2" data-v-ac00a8b8>创意实践展示</h3><p class="text-slate-600 text-sm leading-relaxed mb-3" data-v-ac00a8b8>选手可使用洞洞板、自制PCB或个人开发板进行创意设计，展示技术实力和创新能力。</p><div class="text-xs text-amber-700 bg-amber-100 rounded-lg p-2" data-v-ac00a8b8><strong data-v-ac00a8b8>注意：</strong>获奖作品将用于科技节展出，不予返还。 </div></div></div></div></div></div></div><section class="mb-12 sm:mb-20" data-v-ac00a8b8><h2 class="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 bg-gradient-to-r from-sky-600 to-emerald-600 bg-clip-text text-transparent" data-v-ac00a8b8> 快速参考 </h2><div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6" data-v-ac00a8b8><div class="group bg-gradient-to-br from-blue-50 to-white border border-blue-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:border-blue-300 transition-all duration-300 hover:transform hover:scale-105 shadow-sm" data-v-ac00a8b8><div class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-blue-200 transition-colors" data-v-ac00a8b8><svg class="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac00a8b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" data-v-ac00a8b8></path></svg></div><h3 class="text-lg sm:text-xl font-bold text-blue-700 mb-1 sm:mb-2" data-v-ac00a8b8>竞赛支持</h3><p class="text-slate-600 text-sm" data-v-ac00a8b8>QQ群1074178437提供全程答疑，赛前培训+材料包让你零基础也能快速上手。</p></div><div class="group bg-gradient-to-br from-emerald-50 to-white border border-emerald-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:border-emerald-300 transition-all duration-300 hover:transform hover:scale-105 shadow-sm" data-v-ac00a8b8><div class="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-100 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-emerald-200 transition-colors" data-v-ac00a8b8><svg class="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac00a8b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-v-ac00a8b8></path></svg></div><h3 class="text-lg sm:text-xl font-bold text-emerald-700 mb-1 sm:mb-2" data-v-ac00a8b8>赛程安排</h3><p class="text-slate-600 text-sm" data-v-ac00a8b8>2025年12月7日，上午场9:00-11:00，下午场14:00-16:00，信息楼一二合班，任选一场参与。</p></div><div class="group bg-gradient-to-br from-purple-50 to-white border border-purple-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:border-purple-300 transition-all duration-300 hover:transform hover:scale-105 shadow-sm" data-v-ac00a8b8><div class="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-purple-200 transition-colors" data-v-ac00a8b8><svg class="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac00a8b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" data-v-ac00a8b8></path></svg></div><h3 class="text-lg sm:text-xl font-bold text-purple-700 mb-1 sm:mb-2" data-v-ac00a8b8>报名须知</h3><p class="text-slate-600 text-sm" data-v-ac00a8b8>2-3人组队，报名费21元/队。支付时备注&quot;年级+班级+姓名&quot;，否则无法确认报名。</p></div></div></section><section class="mb-12 sm:mb-20" data-v-ac00a8b8><h2 class="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 bg-gradient-to-r from-sky-600 to-emerald-600 bg-clip-text text-transparent" data-v-ac00a8b8> 往届精彩瞬间 </h2><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6" data-v-ac00a8b8><div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white hover:border-sky-300 transition-all duration-300 shadow-sm" data-v-ac00a8b8><div class="aspect-video bg-gradient-to-br from-sky-50 to-slate-50 flex items-center justify-center overflow-hidden" data-v-ac00a8b8><img src="'+NT+'" alt="LED创意作品展示" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" data-v-ac00a8b8><div class="absolute inset-0 bg-gradient-to-br from-sky-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" data-v-ac00a8b8></div></div></div><div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 transition-all duration-300 shadow-sm" data-v-ac00a8b8><div class="aspect-video bg-gradient-to-br from-emerald-50 to-slate-50 flex items-center justify-center overflow-hidden" data-v-ac00a8b8><img src="'+FT+'" alt="作品制作过程" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" data-v-ac00a8b8><div class="absolute inset-0 bg-gradient-to-br from-emerald-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" data-v-ac00a8b8></div></div></div><div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white hover:border-violet-300 transition-all duration-300 shadow-sm" data-v-ac00a8b8><div class="aspect-video bg-gradient-to-br from-violet-50 to-slate-50 flex items-center justify-center overflow-hidden" data-v-ac00a8b8><img src="'+OT+'" alt="获奖作品展示" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" data-v-ac00a8b8><div class="absolute inset-0 bg-gradient-to-br from-violet-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" data-v-ac00a8b8></div></div></div></div></section>',4)),R("section",KT,[R("div",ZT,[y[38]||(y[38]=R("div",{class:"absolute inset-0 opacity-3"},[R("div",{class:"absolute inset-0",style:{"background-image":"radial-gradient(circle at 25% 25%, #0ea5e9 1px, transparent 1px), radial-gradient(circle at 75% 75%, #10b981 1px, transparent 1px)","background-size":"40px 40px"}})],-1)),R("div",JT,[i.value===1?(ne(),ie("div",QT,[...y[16]||(y[16]=[R("h2",{class:"text-2xl sm:text-4xl font-bold text-slate-800 mb-2 sm:mb-4"},"比赛队伍报名 - 步骤1/2",-1),R("p",{class:"text-slate-600 text-sm sm:text-base"},"填写队伍信息，完成后进入支付环节",-1)])])):dt("",!0),i.value===1?(ne(),ie("div",ew,[R("div",tw,[R("div",nw,[y[17]||(y[17]=R("label",{class:"text-sm text-sky-700 font-medium flex items-center gap-2"},[R("span",{class:"w-2 h-2 bg-sky-500 rounded-full animate-pulse"}),it(" 队伍名称 ")],-1)),Me(R("input",{"onUpdate:modelValue":y[0]||(y[0]=S=>t.value.teamName=S),onInput:y[1]||(y[1]=S=>l.value.teamName=""),type:"text",class:At(["w-full bg-white/80 border border-slate-300 rounded-xl px-4 py-3 sm:py-4 text-slate-800 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/50 transition-all duration-300 backdrop-blur-sm text-base sm:text-lg placeholder-slate-400",{"border-red-500 focus:border-red-500 focus:ring-red-500/50":l.value.teamName}]),placeholder:"给你们的队伍起个响亮的名字"},null,34),[[nn,t.value.teamName]]),l.value.teamName?(ne(),ie("span",iw,ot(l.value.teamName),1)):dt("",!0)])]),R("div",rw,[R("div",sw,[y[18]||(y[18]=R("label",{class:"text-sm text-sky-700 font-medium flex items-center gap-2"},[R("span",{class:"w-2 h-2 bg-sky-500 rounded-full animate-pulse",style:{"animation-delay":"0.1s"}}),it(" 队长姓名 ")],-1)),Me(R("input",{"onUpdate:modelValue":y[2]||(y[2]=S=>t.value.leaderName=S),onInput:y[3]||(y[3]=S=>l.value.leaderName=""),type:"text",class:At(["w-full bg-white/80 border border-slate-300 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/50 transition-all duration-300 backdrop-blur-sm placeholder-slate-400",{"border-red-500 focus:border-red-500 focus:ring-red-500/50":l.value.leaderName}]),placeholder:"请输入队长姓名"},null,34),[[nn,t.value.leaderName]]),l.value.leaderName?(ne(),ie("span",ow,ot(l.value.leaderName),1)):dt("",!0)]),R("div",aw,[y[19]||(y[19]=R("label",{class:"text-sm text-sky-700 font-medium flex items-center gap-2"},[R("span",{class:"w-2 h-2 bg-sky-500 rounded-full animate-pulse",style:{"animation-delay":"0.2s"}}),it(" 队长学号 ")],-1)),Me(R("input",{"onUpdate:modelValue":y[4]||(y[4]=S=>t.value.leaderStudentId=S),onInput:y[5]||(y[5]=S=>l.value.leaderStudentId=""),type:"text",class:At(["w-full bg-white/80 border border-slate-300 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/50 transition-all duration-300 backdrop-blur-sm placeholder-slate-400",{"border-red-500 focus:border-red-500 focus:ring-red-500/50":l.value.leaderStudentId}]),placeholder:"请输入队长学号"},null,34),[[nn,t.value.leaderStudentId]]),l.value.leaderStudentId?(ne(),ie("span",lw,ot(l.value.leaderStudentId),1)):dt("",!0)])]),R("div",cw,[R("div",uw,[y[20]||(y[20]=R("label",{class:"text-sm text-sky-700 font-medium flex items-center gap-2"},[R("span",{class:"w-2 h-2 bg-sky-500 rounded-full animate-pulse",style:{"animation-delay":"0.25s"}}),it(" 队长年级 ")],-1)),R("div",dw,[(ne(),ie(Mt,null,En(["25","24","23","22"],S=>R("button",{key:S,type:"button",onClick:x=>{t.value.leaderGrade=S,l.value.leaderGrade=""},class:At(["px-2 py-2 rounded-lg border text-sm transition active:scale-95",t.value.leaderGrade===S?"bg-sky-500 text-white border-sky-500 shadow-sm":"bg-white/80 text-slate-700 border-slate-300 hover:border-sky-400",l.value.leaderGrade?"border-red-500":""])},ot(S)+" 级 ",11,fw)),64))]),l.value.leaderGrade?(ne(),ie("span",hw,ot(l.value.leaderGrade),1)):dt("",!0)]),R("div",pw,[y[21]||(y[21]=R("label",{class:"text-sm text-sky-700 font-medium flex items-center gap-2"},[R("span",{class:"w-2 h-2 bg-sky-500 rounded-full animate-pulse",style:{"animation-delay":"0.3s"}}),it(" 队长专业与班级 ")],-1)),Me(R("input",{"onUpdate:modelValue":y[6]||(y[6]=S=>t.value.leaderMajorClass=S),onInput:y[7]||(y[7]=S=>l.value.leaderMajorClass=""),type:"text",class:At(["w-full bg-white/80 border border-slate-300 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/50 transition-all duration-300 backdrop-blur-sm placeholder-slate-400",{"border-red-500 focus:border-red-500 focus:ring-red-500/50":l.value.leaderMajorClass}]),placeholder:"例如：电子三班"},null,34),[[nn,t.value.leaderMajorClass]]),l.value.leaderMajorClass?(ne(),ie("span",mw,ot(l.value.leaderMajorClass),1)):dt("",!0)])]),R("div",gw,[R("div",vw,[y[22]||(y[22]=R("div",{class:"flex items-center gap-2"},[R("span",{class:"w-2 h-2 bg-emerald-500 rounded-full animate-pulse",style:{"animation-delay":"0.4s"}}),it(" 队友信息（选填，最多 2 名） ")],-1)),R("button",{type:"button",onClick:d,class:"px-3 py-1.5 rounded-full text-xs bg-emerald-500 text-white shadow-sm active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed",disabled:t.value.members.length>=2}," 添加队友 ",8,_w)]),R("div",xw,[(ne(!0),ie(Mt,null,En(t.value.members,(S,x)=>(ne(),ie("div",{key:x,class:"rounded-2xl border border-emerald-200 bg-emerald-50/60 px-4 py-3 space-y-3 relative"},[R("div",bw,[R("span",null,"队友 "+ot(x+1),1),R("button",{type:"button",class:"text-emerald-700/70 hover:text-emerald-900 active:scale-95",onClick:C=>f(x)}," 删除 ",8,yw)]),R("div",Sw,[R("div",Mw,[y[23]||(y[23]=R("label",{class:"text-xs text-slate-600"},"姓名",-1)),Me(R("input",{"onUpdate:modelValue":C=>S.name=C,onInput:C=>l.value.members[x].name="",type:"text",class:At(["w-full bg-white border border-slate-200 rounded-xl px-3 py-2.5 text-slate-800 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/40 text-sm placeholder-slate-400",{"border-red-500 focus:border-red-500 focus:ring-red-500/40":l.value.members[x]?.name}]),placeholder:"队友姓名"},null,42,Ew),[[nn,S.name]]),l.value.members[x]?.name?(ne(),ie("span",Tw,ot(l.value.members[x].name),1)):dt("",!0)]),R("div",ww,[y[24]||(y[24]=R("label",{class:"text-xs text-slate-600"},"学号",-1)),Me(R("input",{"onUpdate:modelValue":C=>S.studentId=C,onInput:C=>l.value.members[x].studentId="",type:"text",class:At(["w-full bg-white border border-slate-200 rounded-xl px-3 py-2.5 text-slate-800 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/40 text-sm placeholder-slate-400",{"border-red-500 focus:border-red-500 focus:ring-red-500/40":l.value.members[x]?.studentId}]),placeholder:"队友学号"},null,42,Aw),[[nn,S.studentId]]),l.value.members[x]?.studentId?(ne(),ie("span",Rw,ot(l.value.members[x].studentId),1)):dt("",!0)])]),R("div",Cw,[R("div",Pw,[y[25]||(y[25]=R("label",{class:"text-xs text-slate-600"},"年级",-1)),R("div",Dw,[(ne(),ie(Mt,null,En(["25","24","23","22"],C=>R("button",{key:C,type:"button",onClick:L=>{S.grade=C,l.value.members[x].grade=""},class:At(["px-2 py-1.5 rounded-lg border text-[11px] leading-none transition active:scale-95",S.grade===C?"bg-emerald-500 text-white border-emerald-500":"bg-white text-slate-700 border-slate-300 hover:border-emerald-400",l.value.members[x]?.grade?"border-red-500":""])},ot(C)+" 级 ",11,Lw)),64))]),l.value.members[x]?.grade?(ne(),ie("span",Iw,ot(l.value.members[x].grade),1)):dt("",!0)]),R("div",Uw,[y[26]||(y[26]=R("label",{class:"text-xs text-slate-600"},"专业与班级",-1)),Me(R("input",{"onUpdate:modelValue":C=>S.majorClass=C,onInput:C=>l.value.members[x].majorClass="",type:"text",class:At(["w-full bg-white border border-slate-200 rounded-xl px-3 py-2.5 text-slate-800 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/40 text-sm placeholder-slate-400",{"border-red-500 focus:border-red-500 focus:ring-red-500/40":l.value.members[x]?.majorClass}]),placeholder:"例如：机器人一班"},null,42,Nw),[[nn,S.majorClass]]),l.value.members[x]?.majorClass?(ne(),ie("span",Fw,ot(l.value.members[x].majorClass),1)):dt("",!0)])])]))),128))])]),R("div",Ow,[R("div",Bw,[y[27]||(y[27]=R("label",{class:"text-sm text-sky-700 font-medium flex items-center gap-2"},[R("span",{class:"w-2 h-2 bg-sky-500 rounded-full animate-pulse",style:{"animation-delay":"0.45s"}}),it(" 联系方式（队长 QQ / 微信 / 手机） ")],-1)),Me(R("input",{"onUpdate:modelValue":y[8]||(y[8]=S=>t.value.contact=S),onInput:y[9]||(y[9]=S=>l.value.contact=""),type:"text",class:At(["w-full bg-white/80 border border-slate-300 rounded-xl px-4 py-3 sm:py-4 text-slate-800 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/50 transition-all duration-300 backdrop-blur-sm text-base sm:text-lg placeholder-slate-400",{"border-red-500 focus:border-red-500 focus:ring-red-500/50":l.value.contact}]),placeholder:"方便我们与队长取得联系"},null,34),[[nn,t.value.contact]]),l.value.contact?(ne(),ie("span",kw,ot(l.value.contact),1)):dt("",!0)])]),R("button",{onClick:c,class:"w-full bg-gradient-to-r from-sky-500 via-blue-500 to-emerald-500 active:from-sky-400 active:via-blue-400 active:to-emerald-400 text-white font-bold py-4 sm:py-5 rounded-xl sm:rounded-2xl shadow-lg shadow-sky-500/20 transform transition-all duration-300 active:scale-[0.98] cursor-pointer relative overflow-hidden group touch-manipulation"},[...y[28]||(y[28]=[R("span",{class:"relative z-10"},"下一步：支付报名费",-1),R("div",{class:"absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 group-active:opacity-50 transition-opacity duration-300"},null,-1)])])])):i.value===2?(ne(),ie("div",zw,[y[37]||(y[37]=R("div",{class:"text-center mb-8"},[R("h2",{class:"text-2xl sm:text-4xl font-bold text-slate-800 mb-2"},"支付报名费 - 步骤2/2"),R("p",{class:"text-slate-600 text-sm sm:text-base"},"完成支付以确认报名")],-1)),o.value?(ne(),ie("div",Hw,[...y[29]||(y[29]=[kt('<div class="bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200 rounded-2xl p-8 mb-6" data-v-ac00a8b8><div class="w-20 h-20 bg-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4" data-v-ac00a8b8><svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac00a8b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" data-v-ac00a8b8></path></svg></div><h3 class="text-2xl font-bold text-emerald-700 mb-2" data-v-ac00a8b8>报名成功！</h3><p class="text-emerald-600 mb-4" data-v-ac00a8b8>我们已收到您的报名信息</p><p class="text-sm text-emerald-500" data-v-ac00a8b8>3秒后自动返回首页...</p></div>',1)])])):(ne(),ie("div",Vw,[y[36]||(y[36]=kt('<div class="bg-white/80 backdrop-blur-sm p-6 rounded-2xl mb-6 border border-slate-200" data-v-ac00a8b8><h2 class="text-2xl font-bold text-slate-800 mb-6" data-v-ac00a8b8>完成支付确认报名</h2><div class="bg-gradient-to-r from-sky-50 to-emerald-50 rounded-xl p-4 mb-6 border border-sky-200" data-v-ac00a8b8><p class="text-sky-800 font-semibold text-lg mb-2" data-v-ac00a8b8>报名费用：21元/队</p><p class="text-sm text-sky-700" data-v-ac00a8b8>每支队伍2-3人，费用包含材料费、评审费</p></div><div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 mb-6 border border-blue-200" data-v-ac00a8b8><p class="text-sm text-blue-700" data-v-ac00a8b8>QQ群：1074178437</p></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" data-v-ac00a8b8><div class="text-center" data-v-ac00a8b8><h3 class="text-lg font-semibold text-slate-800 mb-3" data-v-ac00a8b8>扫描下方二维码支付</h3><div class="w-48 h-64 sm:w-56 sm:h-72 mx-auto bg-white rounded-xl border-4 border-slate-200 shadow-lg overflow-hidden" data-v-ac00a8b8><img src="'+BT+'" alt="收款二维码" class="w-full h-full object-cover" data-v-ac00a8b8></div></div><div class="text-center" data-v-ac00a8b8><h3 class="text-lg font-semibold text-slate-800 mb-3" data-v-ac00a8b8>支付备注填写示例</h3><div class="w-48 h-64 sm:w-56 sm:h-72 mx-auto bg-white rounded-xl border-4 border-slate-200 shadow-lg overflow-hidden" data-v-ac00a8b8><img src="'+kT+'" alt="备注示例" class="w-full h-full object-cover" data-v-ac00a8b8></div></div></div></div><div class="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl p-4 mb-6 border border-amber-200" data-v-ac00a8b8><p class="text-base text-amber-700 mb-2" data-v-ac00a8b8><span class="inline-block w-6 h-6 bg-amber-500 rounded-full text-white font-bold mr-2 text-center" data-v-ac00a8b8>⚠</span> 重要提醒 </p><p class="text-sm text-amber-600" data-v-ac00a8b8> 支付时请务必在<span class="font-bold text-slate-800 underline mx-1" data-v-ac00a8b8>备注</span>中填写你的<span class="font-bold text-slate-800 mx-1" data-v-ac00a8b8>年级+班级+姓名</span>，否则无法确认报名！ </p><p class="text-xs text-amber-500 mt-2" data-v-ac00a8b8>参考右侧示例图片，确保备注格式正确</p></div>',2)),R("div",Gw,[a.value?(ne(),ie("div",Ww,[y[32]||(y[32]=R("svg",{class:"w-5 h-5 flex-shrink-0 mt-0.5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[R("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})],-1)),R("div",null,[y[30]||(y[30]=R("p",{class:"font-bold"},"提交失败",-1)),R("p",null,ot(a.value),1),y[31]||(y[31]=R("p",{class:"mt-1 text-xs opacity-80"},"如已支付成功，请勿重复支付，我们会人工核对信息后联系您。",-1))])])):dt("",!0),R("button",{onClick:u,disabled:s.value,class:"w-full bg-gradient-to-r from-emerald-500 via-green-500 to-emerald-500 active:from-emerald-400 active:via-green-400 active:to-emerald-400 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-500/20 transform transition-all duration-300 active:scale-[0.98] cursor-pointer relative overflow-hidden group disabled:opacity-70 disabled:cursor-not-allowed"},[s.value?(ne(),ie("span",jw,[...y[33]||(y[33]=[R("svg",{class:"animate-spin -ml-1 mr-3 h-5 w-5 text-white inline",xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},[R("circle",{class:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor","stroke-width":"4"}),R("path",{class:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})],-1),it(" 正在提交... ",-1)])])):(ne(),ie("span",$w,"我已确认支付，提交信息")),y[34]||(y[34]=R("div",{class:"absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 group-active:opacity-50 transition-opacity duration-300"},null,-1))],8,Xw),R("div",qw,[R("button",{onClick:y[10]||(y[10]=S=>i.value=1),class:"group text-slate-500 hover:text-sky-600 text-sm underline cursor-pointer transition-colors"},[...y[35]||(y[35]=[R("span",{class:"flex items-center gap-2"},[R("svg",{class:"w-4 h-4 group-hover:-translate-x-1 transition-transform",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[R("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 19l-7-7m0 0l7-7m-7 7h18"})]),it(" 返回上一步修改信息 ")],-1)])])])])]))])):dt("",!0)])])]),R("div",Yw,[(ne(),ie(Mt,null,En(15,S=>R("div",{key:S,class:At(["absolute w-1 h-1 rounded-full animate-ping opacity-30",Math.random()>.5?"bg-sky-400":"bg-emerald-400"]),style:ai(`
               left: ${Math.random()*100}%;
               top: ${Math.random()*100}%;
               animation-delay: ${Math.random()*5}s;
               animation-duration: ${4+Math.random()*6}s;
             `)},null,6)),64))])])]))}}),Zw=Gn(Kw,[["__scopeId","data-v-ac00a8b8"]]),Jw=iv({history:Ng("/"),routes:[{path:"/",name:"home",component:UT},{path:"/led-competition",name:"led-competition",component:Zw}],scrollBehavior(n,e,t){return t||{top:0}}}),ha=q0(Nv);ha.use(Jw);const xp=new IntersectionObserver(n=>{n.forEach(e=>{if(e.isIntersecting){const t=e.target;t.classList.add("reveal-in"),xp.unobserve(t)}})},{threshold:.18,rootMargin:"0px 0px -10% 0px"});ha.directive("reveal",{mounted(n,e){n.classList.add("reveal-init","reveal-anim");const t=typeof e.value=="object"&&e.value?e.value:{},i=e.arg||t.variant;i&&n.classList.add("reveal-"+i);const r=t.delay||0;r&&(n.style.transitionDelay=r+"ms"),xp.observe(n)}});ha.directive("tilt",{mounted(n,e){const t=navigator.userAgent;if(/Mobi|Android|iPhone|iPad|iPod|Phone/i.test(t))return;const r=typeof e.value=="object"&&e.value?e.value:{},s=Number(r.max||e.value||10),o=Number(r.scale||1.02),a=Number(r.perspective||800);let l=0,c=!1;const u=()=>{c=!0,n.style.willChange="transform",n.style.transition="transform 180ms ease",n.classList.add("tilt-active")},d=()=>{c=!1,cancelAnimationFrame(l),n.style.transform=`perspective(${a}px)`,n.style.transition="transform 220ms cubic-bezier(.2,.6,.2,1)",n.classList.remove("tilt-active")},f=p=>{c&&(cancelAnimationFrame(l),l=requestAnimationFrame(()=>{const v=n.getBoundingClientRect(),g=v.left+v.width/2,m=v.top+v.height/2,h=(p.clientX-g)/(v.width/2),S=(-((p.clientY-m)/(v.height/2))*s).toFixed(2),x=(h*s).toFixed(2);n.style.transform=`perspective(${a}px) rotateX(${S}deg) rotateY(${x}deg) scale(${o})`}))};n.addEventListener("mouseenter",u),n.addEventListener("mousemove",f),n.addEventListener("mouseleave",d),n.__tiltCleanup=()=>{n.removeEventListener("mouseenter",u),n.removeEventListener("mousemove",f),n.removeEventListener("mouseleave",d)}},unmounted(n){n.__tiltCleanup?.()}});ha.mount("#app");(function(){const e=navigator.userAgent;if(!/Mobi|Android|iPhone|iPad|iPod|Phone/i.test(e))return;const i="/bgm.m4a",r=new Audio(i);window.__bgm=r,r.loop=!0,r.preload="auto"})();(function(){if(typeof window>"u"||typeof document>"u")return;const e=document.createElement("div");e.className="scroll-progress";const t=document.createElement("div");t.className="scroll-progress__bar",e.appendChild(t),document.body.appendChild(e);let i=null;const r=()=>{i=null;const o=document.documentElement,a=document.body,l=o.scrollTop||a.scrollTop,c=(o.scrollHeight||a.scrollHeight)-o.clientHeight,u=c>0?Math.min(1,l/c):0;t.style.transform=`scaleX(${u})`},s=()=>{i==null&&(i=requestAnimationFrame(r))};window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),r()})();console.log("咦 竟然是个会看终端的聪明宝宝");console.log("那我在这里加点私货应该也没事吧QwQ");console.log(`
       　  　▃▆█▇▄▖
　 　 　 ▟◤▖　　　◥█▎
  　 ◢◤　 ▐　　　 　▐▉
　 ▗◤　　　▂　▗▖　　▕█▎
