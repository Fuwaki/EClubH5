...
<template>
  <div class="relative px-4 sm:px-5 py-14 sm:py-16 bg-black/20 border-t border-white/5">
    <div class="w-full max-w-screen-lg mx-auto" v-reveal>
      ...
      <p class="mt-4 sm:mt-5 text-emerald-100/85 text-[15px] sm:text-base leading-relaxed px-1 sm:px-0" v-reveal:"up"
        :reveal="{ delay: 100 }">老牌部门+社团，助你快速成长</p>
            ...
            <div
              ...
              <div class="flex items-start">
                ...
                <div class="ml-4">
                  ...
                  <p class="mt-1 text-xs text-cyan-100/80">懂方法，能应用，强配合</p>
