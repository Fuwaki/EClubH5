      ...
      <div
        ...
        <div class="space-y-6">
          <div class="relative pl-6 border-l-2 border-emerald-500/30">
            ...
            <p class="text-slate-600 leading-relaxed">就像学习任何技能一样，我们从基础开始。第一部分用51单片机完成指定效果，打好扎实基础；第二部分放手创新，让想象力自由飞翔。</p>
          </div>
        ...
        <div class="relative z-10">
          ...
          <div v-if="step === 1" class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <div class="space-y-2">
                ...
                <input v-model="form.leaderName" @input="errors.leaderName = ''" type="text"
                  ...
                  placeholder="请输入队长姓名" />
                <span v-if="errors.leaderName" class="text-red-500 text-xs mt-1 block ml-1">{{ errors.leaderName }}</span>
              </div>
              ...
              <div class="space-y-2">
                ...
                <input v-model="form.leaderStudentId" @input="errors.leaderStudentId = ''" type="text"
                  ...
                  placeholder="请输入队长学号" />
                <span v-if="errors.leaderStudentId" class="text-red-500 text-xs mt-1 block ml-1">{{ errors.leaderStudentId }}</span>
              </div>
            </div>
            ...
            <div class="grid sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div class="space-y-2">
                ...
                <span v-if="errors.leaderGrade" class="text-red-500 text-xs mt-1 block ml-1">{{ errors.leaderGrade }}</span>
              </div>
              ...
              <div class="space-y-2">
                ...
                <input v-model="form.leaderMajorClass" @input="errors.leaderMajorClass = ''" type="text"
                  ...
                  placeholder="例如：电子三班" />
                <span v-if="errors.leaderMajorClass" class="text-red-500 text-xs mt-1 block ml-1">{{ errors.leaderMajorClass }}</span>
              </div>
            </div>
                ...
                <div v-for="(member, idx) in form.members" :key="idx"
                  ...
                  <div class="grid sm:grid-cols-2 gap-3">
                    <div class="space-y-1.5">
                      ...
                      <input v-model="member.name" @input="errors.members[idx].name = ''" type="text"
                        ...
                        placeholder="队友姓名" />
                      <span v-if="errors.members[idx]?.name" class="text-red-500 text-xs mt-1 block ml-1">{{ errors.members[idx].name }}</span>
                    </div>
                    <div class="space-y-1.5">
                      ...
                      <input v-model="member.studentId" @input="errors.members[idx].studentId = ''" type="text"
                        ...
                        placeholder="队友学号" />
                      <span v-if="errors.members[idx]?.studentId" class="text-red-500 text-xs mt-1 block ml-1">{{ errors.members[idx].studentId }}</span>
                    </div>
                  </div>
                  ...
                  <div class="grid sm:grid-cols-2 gap-3">
                    <div class="space-y-1.5">
                      ...
                      <span v-if="errors.members[idx]?.grade" class="text-red-500 text-xs mt-1 block ml-1">{{ errors.members[idx].grade }}</span>
                    </div>
                    <div class="space-y-1.5">
                      ...
                      <span v-if="errors.members[idx]?.majorClass" class="text-red-500 text-xs mt-1 block ml-1">{{ errors.members[idx].majorClass }}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div v-else-if="step === 2" class="max-w-4xl mx-auto animate-fade-in">
            ...
            <div v-if="isSuccess" class="text-center max-w-md mx-auto mb-8">
              <div class="bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200 rounded-2xl p-8 mb-6">
            ...
            <div v-else class="text-center max-w-4xl mx-auto">
              <div class="bg-white/80 backdrop-blur-sm p-6 rounded-2xl mb-6 border border-slate-200">
                ...
                <p class="text-sm text-slate-600 mb-4">请务必在支付备注中填写：<span class="font-bold text-emerald-700">姓名+学号</span>
                </p>
              </div>
              ...
              <div class="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl p-4 mb-6 border border-amber-200">
                ...
                <p class="text-sm text-amber-600">
                  支付时请务必在<span class="font-bold text-slate-800 underline mx-1">备注</span>中填写你的<span
                    class="font-bold text-slate-800 mx-1">姓名+学号</span>，否则无法确认报名！
                </p>
              ...
              <div class="flex flex-col gap-4">
                <!-- 错误提示 -->
                <div v-if="submitError" class="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl text-sm flex items-start gap-2 animate-fade-in">
                ...
                <button @click="confirmPayment" :disabled="isSubmitting"
                  ...
                  <span class="relative z-10" v-if="!isSubmitting">我已经确认支付</span>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <p class="text-xs text-slate-400">支付完成后，点击确认支付按钮完成报名</p>
                </div>
              </div>
            </div>
          </div>
